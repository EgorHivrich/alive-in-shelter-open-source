...
/*  75 */       Method mainMethod = replacedMainClass.getMethod("main", new Class[] { String[].class });
...
/*     */     }
/* 104 */     Class<?> clazz = defineClass(name, bytecode, 0, bytecode.length);
...
/*     */       } 
/*     */     } 
/* 148 */     Class<?> clazz = defineClass(name, bytecode, 0, bytecode.length);
/* 149 */     if (resolve)
...
/*     */       try {
/* 179 */         in.close();
/* 180 */       } catch (IOException iOException) {} } finally { try { in.close(); } catch (IOException exc) {} }
/*     */ 
/*     */ 
/*     */     
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjg\\util\mapped\MappedObjectClassLoader.class
