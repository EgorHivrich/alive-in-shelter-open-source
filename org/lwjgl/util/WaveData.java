...
/* 192 */         channels = 4353;
/*     */       } else {
/* 194 */         assert false : "Illegal sample size";
/*     */       } 
...
/* 200 */         channels = 4355;
/*     */       } else {
/* 202 */         assert false : "Illegal sample size";
/*     */       } 
/*     */     } else {
/* 205 */       assert false : "Only mono or stereo is supported";
/*     */     } 
/*     */ 
/*     */     
...
/* 216 */       int read = 0, total = 0;
/*     */       
/* 218 */       while ((read = ais.read(buf, total, buf.length - total)) != -1 && total < buf.length) {
/* 219 */         total += read;
/*     */       }
/* 221 */       buffer = convertAudioBytes(buf, (audioformat.getSampleSizeInBits() == 16), audioformat.isBigEndian() ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN);
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjg\\util\WaveData.class
