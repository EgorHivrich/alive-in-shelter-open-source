...
/* 154 */   private static GLUtessellatorCallback NULL_CB = (GLUtessellatorCallback)new GLUtessellatorCallbackAdapter();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 222 */           gluTessBeginPolygon(null); continue;
/* 223 */         }  if (this.state == 1) {
...
/* 230 */         gluTessEndContour(); continue;
/* 231 */       }  if (this.state == 1) {
...
/* 245 */     switch (which) {
/*     */       case 100142:
/* 247 */         if (value < 0.0D || value > 1.0D)
/* 248 */           break;  this.relTolerance = value;
/*     */         return;
/*     */       
/*     */       case 100140:
/* 252 */         windingRule = (int)value;
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjg\\util\glu\tessellation\GLUtessellatorImpl.class
