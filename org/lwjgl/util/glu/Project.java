...
/*     */   extends Util
/*     */ {
/*  52 */   private static final float[] IDENTITY_MATRIX = new float[] { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 132 */         for (int m = 0; m < 4; m++) {
/* 133 */           float f = temp.get(i * 4 + m);
/* 134 */           temp.put(i * 4 + m, temp.get(swap * 4 + m));
/* 135 */           temp.put(swap * 4 + m, f);
/*     */           
/* 137 */           f = inverse.get(i * 4 + m);
/* 138 */           inverse.put(i * 4 + m, inverse.get(swap * 4 + m));
/*     */           
/* 140 */           inverse.put(swap * 4 + m, f);
/*     */         } 
/*     */       }
/*     */ 
/*     */       
...
/*     */       }
/*     */       
/* 153 */       float t = temp.get(i * 4 + i); int k;
/* 154 */       for (k = 0; k < 4; k++) {
...
/* 198 */     float radians = fovy / 2.0F * 3.1415927F / 180.0F;
/*     */     
...
/* 302 */     float[] in = Project.in;
/* 303 */     float[] out = Project.out;
/*     */     
/* 305 */     in[0] = objx;
/* 306 */     in[1] = objy;
/* 307 */     in[2] = objz;
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjg\\util\glu\Project.class
