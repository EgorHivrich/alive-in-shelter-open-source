...
/*     */ 
/*     */   
/* 112 */   private static final Map<String, Integer> buttonMap = new HashMap<String, Integer>(16);
/*     */ 
/*     */   
...
/* 369 */         absolute_x = x = poll_coord1;
/* 370 */         absolute_y = y = poll_coord2;
/*     */       } 
/*     */       
...
/* 425 */       Integer ret = buttonMap.get(buttonName);
/* 426 */       if (ret == null) {
/* 427 */         return -1;
/*     */       }
...
/* 695 */     Boolean value = AccessController.<Boolean>doPrivileged(new PrivilegedAction<Boolean>() {
/*     */           public Boolean run() {
/* 697 */             return Boolean.valueOf(Boolean.getBoolean(property_name));
/*     */           }
/*     */         });
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\input\Mouse.class
