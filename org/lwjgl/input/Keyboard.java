...
/* 235 */         if (Modifier.isStatic(field.getModifiers()) && Modifier.isPublic(field.getModifiers()) && Modifier.isFinal(field.getModifiers()) && field.getType().equals(int.class) && field.getName().startsWith("KEY_") && !field.getName().endsWith("WIN"))
/*     */         {
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\input\Keyboard.class
