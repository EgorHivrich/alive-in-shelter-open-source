...
/* 242 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 243 */     int __result = 0;
/*     */     try {
...
/* 269 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 270 */     int __result = 0;
/*     */     try {
...
/* 289 */     BufferChecks.checkArray((Object[])header_include_names, 1);
/* 290 */     long user_data = CallbackUtil.createGlobalRef(pfn_notify);
/* 291 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 292 */     int __result = 0;
/*     */     try {
...
/* 310 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 311 */     int __result = 0;
/*     */     try {
...
/* 327 */     BufferChecks.checkArray((Object[])header_include_name);
/* 328 */     long user_data = CallbackUtil.createGlobalRef(pfn_notify);
/* 329 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 330 */     int __result = 0;
/*     */     try {
...
/* 394 */     int __result = nclGetKernelArgInfo(kernel.getPointer(), arg_indx, param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
/* 395 */     return __result;
/*     */   }
...
/* 479 */     long function_pointer = CLCapabilities.clGetExtensionFunctionAddressForPlatform;
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opencl\CL12.class
