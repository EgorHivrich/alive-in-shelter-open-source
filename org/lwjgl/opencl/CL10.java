...
/*  413 */     int __result = nclGetPlatformInfo((platform == null) ? 0L : platform.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
/*  414 */     return __result;
/*      */   }
...
/*  440 */     int __result = nclGetDeviceInfo(device.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
/*  441 */     return __result;
/*      */   }
/*      */ 
/*      */   
...
/*      */     try {
/*  482 */       __result = new CLContext(nclCreateContext(MemoryUtil.getAddress(properties), 1, APIUtil.getPointer((PointerWrapper)device), (pfn_notify == null) ? 0L : pfn_notify.getPointer(), user_data, MemoryUtil.getAddressSafe(errcode_ret), function_pointer), APIUtil.getCLPlatform(properties));
/*  483 */       return __result;
/*      */     } finally {
...
/*  511 */     long function_pointer = CLCapabilities.clRetainContext;
...
/*  537 */     int __result = nclGetContextInfo(context.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
/*  538 */     if (__result == 0 && param_value != null && APIUtil.isDevicesParam(param_name)) context.getParent().registerCLDevices(param_value, param_value_size_ret); 
/*  539 */     return __result;
/*      */   }
...
/*  579 */     int __result = nclGetCommandQueueInfo(command_queue.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
/*  580 */     return __result;
/*      */   }
...
/* 1117 */     int __result = nclGetImageInfo(image.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1161 */     int __result = nclGetMemObjectInfo(memobj.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1201 */     int __result = nclGetSamplerInfo(sampler.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1234 */     BufferChecks.checkArray((Object[])strings, 1);
...
/* 1256 */     BufferChecks.checkArray((Object[])strings);
...
/* 1296 */     BufferChecks.checkArray((Object[])binaries, 1);
...
/* 1332 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 1333 */     int __result = 0;
/*      */     try {
...
/* 1350 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 1351 */     int __result = 0;
/*      */     try {
...
/* 1365 */     if (pfn_notify != null) pfn_notify.setContext(program.getParent()); 
/* 1366 */     int __result = 0;
/*      */     try {
/* 1368 */       __result = nclBuildProgram(program.getPointer(), 1, APIUtil.getPointer((PointerWrapper)device), APIUtil.getBufferNT(options), (pfn_notify == null) ? 0L : pfn_notify.getPointer(), user_data, function_pointer);
...
/* 1390 */     int __result = nclGetProgramInfo(program.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1416 */     int __result = nclGetProgramInfo2(program.getPointer(), 4454, sizes.remaining(), MemoryUtil.getAddress(sizes), MemoryUtil.getAddress(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1438 */     BufferChecks.checkArray((Object[])param_value);
/* 1439 */     if (param_value_size_ret != null)
/* 1440 */       BufferChecks.checkBuffer(param_value_size_ret, 1); 
/* 1441 */     int __result = nclGetProgramInfo3(program.getPointer(), 4454, param_value.length, param_value, MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1453 */     int __result = nclGetProgramBuildInfo(program.getPointer(), device.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1565 */     int __result = nclSetKernelArg(kernel.getPointer(), arg_index, PointerBuffer.getPointerSize(), APIUtil.getPointerSafe((PointerWrapper)arg_value), function_pointer);
...
/* 1584 */     int __result = nclGetKernelInfo(kernel.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1596 */     int __result = nclGetKernelWorkGroupInfo(kernel.getPointer(), (device == null) ? 0L : device.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1653 */       BufferChecks.checkArray((Object[])mem_list, 1); 
/* 1654 */     if (sizes != null)
...
/* 1674 */     long function_pointer = CLCapabilities.clWaitForEvents;
...
/* 1686 */     int __result = nclWaitForEvents(1, APIUtil.getPointer((PointerWrapper)event), function_pointer);
...
/* 1697 */     int __result = nclGetEventInfo(event.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* 1751 */     int __result = nclEnqueueWaitForEvents(command_queue.getPointer(), 1, APIUtil.getPointer((PointerWrapper)event), function_pointer);
...
/* 1762 */     int __result = nclGetEventProfilingInfo(event.getPointer(), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opencl\CL10.class
