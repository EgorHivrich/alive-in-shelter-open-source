...
/*  51 */     this(pointer, (CLDevice)null, platform);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  71 */       this.subCLDevices = new CLObjectRegistry<CLDevice>();
/*  72 */       if (parent != null)
...
/*  91 */     return this.subCLDevices.getObject(id);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } finally {
/* 186 */       if (!isValid())
/* 187 */         (getParent()).subCLDevices.unregisterObject(this); 
/*     */     } 
/*     */   }
/*     */   CLObjectRegistry<CLDevice> getSubCLDeviceRegistry() {
/* 191 */     return this.subCLDevices;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opencl\CLDevice.class
