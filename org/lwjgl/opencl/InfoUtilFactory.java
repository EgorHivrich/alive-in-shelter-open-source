...
/*     */ {
/*  61 */   static final InfoUtil<CLCommandQueue> CL_COMMAND_QUEUE_UTIL = new InfoUtilAbstract<CLCommandQueue>() {
...
/*     */     };
/*     */   
/*  67 */   static final CLContext.CLContextUtil CL_CONTEXT_UTIL = new CLContextUtil();
/*     */   
...
/*     */ 
/*     */       
/*  79 */       if ((CLCapabilities.getPlatformCapabilities(context.getParent())).OpenCL11) {
...
/*     */       
/*  90 */       List<CLDevice> devices = new ArrayList<CLDevice>(num_devices);
/*  91 */       for (int i = 0; i < num_devices; i++) {
/*  92 */         devices.add(context.getParent().getCLDevice(deviceIDs.get(i)));
/*     */       }
...
/* 103 */       properties.put(4228L).put((PointerWrapper)platform);
...
/* 110 */         properties.put((PointerWrapper)device);
/*     */       }
...
/* 134 */       properties.put(4228L).put((PointerWrapper)platform);
...
/*     */       
/* 154 */       List<CLImageFormat> formats = new ArrayList<CLImageFormat>(num_image_formats);
...
/*     */ 
/*     */   
/* 170 */   static final InfoUtil<CLDevice> CL_DEVICE_UTIL = new CLDeviceUtil();
...
/*     */ 
/*     */   
/* 188 */   static final CLEvent.CLEventUtil CL_EVENT_UTIL = new CLEventUtil();
...
/*     */ 
/*     */   
/* 206 */   static final CLKernel.CLKernelUtil CL_KERNEL_UTIL = new CLKernelUtil();
...
/*     */ 
/*     */   
/* 288 */   static final CLMem.CLMemUtil CL_MEM_UTIL = new CLMemUtil();
...
/*     */ 
/*     */   
/* 420 */   static final CLPlatform.CLPlatformUtil CL_PLATFORM_UTIL = new CLPlatformUtil();
...
/*     */       
/* 438 */       List<CLPlatform> platforms = new ArrayList<CLPlatform>(num_platforms);
...
/*     */       
/* 461 */       List<CLDevice> devices = new ArrayList<CLDevice>(num_devices);
...
/*     */ 
/*     */   
/* 473 */   static final CLProgram.CLProgramUtil CL_PROGRAM_UTIL = new CLProgramUtil();
...
/*     */       
/* 513 */       CL10.clGetProgramInfo(program, 4451, buffer.getBuffer(), (PointerBuffer)null);
/*     */       
/* 515 */       CLPlatform platform = program.getParent().getParent();
...
/*     */       } 
/* 537 */       CL10.clGetProgramInfo(program, sizes, target, (PointerBuffer)null);
/*     */       
/* 539 */       return target;
/*     */     }
/*     */     
...
/* 550 */           target[i] = BufferUtils.createByteBuffer((int)sizes.get(i)); 
...
/*     */ 
/*     */   
/* 600 */   static final InfoUtil<CLSampler> CL_SAMPLER_UTIL = new InfoUtilAbstract<CLSampler>() {
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opencl\InfoUtilFactory.class
