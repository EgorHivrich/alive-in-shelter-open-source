...
/*  99 */     CLMem __result = CLMem.create(nclCreateSubBuffer(buffer.getPointer(), flags, buffer_create_type, MemoryUtil.getAddress(buffer_create_info), MemoryUtil.getAddressSafe(errcode_ret), function_pointer), buffer.getParent());
/* 100 */     return __result;
/*     */   }
...
/* 119 */     long function_pointer = CLCapabilities.clEnqueueReadBufferRect;
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opencl\CL11.class
