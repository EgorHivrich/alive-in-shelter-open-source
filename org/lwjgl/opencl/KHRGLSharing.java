...
/* 45 */     int __result = nclGetGLContextInfoKHR(MemoryUtil.getAddress(properties), param_name, ((param_value == null) ? 0L : param_value.remaining()), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opencl\KHRGLSharing.class
