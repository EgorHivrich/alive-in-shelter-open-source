...
/*     */     }
/* 448 */     return this.view32.get() & 0xFFFFFFFFL;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/* 509 */     return this.view32.get(index) & 0xFFFFFFFFL;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 610 */         dst[i] = this.view32.get() & 0xFFFFFFFFL;
/*     */       }
/*     */     } 
/* 613 */     return this;
/*     */   }
...
/* 871 */       return false; 
/* 872 */     int p = position();
/* 873 */     for (int i = limit() - 1, j = that.limit() - 1; i >= p; i--, j--) {
/* 874 */       long v1 = get(i);
...
/* 898 */     for (int i = position(), j = that.position(); i < n; ) {
/* 899 */       long v1 = get(i);
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\PointerBuffer.class
