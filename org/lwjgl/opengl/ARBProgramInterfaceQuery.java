...
/* 101 */     GL43.glGetProgramResource(program, programInterface, index, props, length, params);
/*     */   }
/*     */   
/*     */   public static int glGetProgramResourceLocation(int program, int programInterface, ByteBuffer name) {
/* 105 */     return GL43.glGetProgramResourceLocation(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   public static int glGetProgramResourceLocation(int program, int programInterface, CharSequence name) {
/* 110 */     return GL43.glGetProgramResourceLocation(program, programInterface, name);
/*     */   }
/*     */   
/*     */   public static int glGetProgramResourceLocationIndex(int program, int programInterface, ByteBuffer name) {
/* 114 */     return GL43.glGetProgramResourceLocationIndex(program, programInterface, name);
/*     */   }
/*     */ 
/*     */   
/*     */   public static int glGetProgramResourceLocationIndex(int program, int programInterface, CharSequence name) {
/* 119 */     return GL43.glGetProgramResourceLocationIndex(program, programInterface, name);
/*     */   }
/*     */ }


/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\ARBProgramInterfaceQuery.class
