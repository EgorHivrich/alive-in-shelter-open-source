...
/*  397 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1158 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1339 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1648 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1666 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1684 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1702 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1790 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1808 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 1896 */     ContextCapabilities caps = GLContext.getCapabilities();
...
/* 2049 */     ByteBuffer __result = nglMapNamedBufferEXT(buffer, access, glGetNamedBufferParameterEXT(buffer, 34660), old_buffer, function_pointer);
...
/* 2118 */     ByteBuffer __result = nglGetNamedBufferPointervEXT(buffer, pname, glGetNamedBufferParameterEXT(buffer, 34660), function_pointer);
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\EXTDirectStateAccess.class
