...
/*     */   
/*     */   void releaseAll() {
/* 312 */     for (int i = 0; i < this.key_down_buffer.length; i++) {
/* 313 */       if (this.key_down_buffer[i] != 0) {
/* 314 */         this.key_down_buffer[i] = 0;
/* 315 */         putKeyboardEvent(i, (byte)0, 0, 0L, false);
/*     */       } 
/*     */     } 
/*     */   }
/*     */   
/*     */   private void handleKeyEvent(long event_ptr, long millis, int event_type, int event_keycode, int event_state) {
/* 321 */     int keycode = getKeycode(event_ptr, event_state);
/* 322 */     byte key_state = getKeyState(event_type);
/* 323 */     boolean repeat = (key_state == this.key_down_buffer[keycode]);
/* 324 */     if (repeat && event_type == 3)
/*     */       return; 
/* 326 */     this.key_down_buffer[keycode] = key_state;
/* 327 */     long nanos = millis * 1000000L;
/* 328 */     if (event_type == 2) {
/* 329 */       if (this.has_deferred_event)
/* 330 */         if (nanos == this.deferred_nanos && event_keycode == this.deferred_event_keycode) {
/* 331 */           this.has_deferred_event = false;
/* 332 */           repeat = true;
/*     */         } else {
/* 334 */           flushDeferredEvent();
/*     */         }  
/* 336 */       translateEvent(event_ptr, keycode, key_state, nanos, repeat);
/*     */     } else {
/* 338 */       flushDeferredEvent();
/* 339 */       this.has_deferred_event = true;
/* 340 */       this.deferred_keycode = keycode;
/* 341 */       this.deferred_event_keycode = event_keycode;
/* 342 */       this.deferred_nanos = nanos;
/* 343 */       this.deferred_key_state = key_state;
/*     */     } 
/*     */   }
/*     */   
/*     */   private void flushDeferredEvent() {
/* 348 */     if (this.has_deferred_event) {
/* 349 */       putKeyboardEvent(this.deferred_keycode, this.deferred_key_state, 0, this.deferred_nanos, false);
/* 350 */       this.has_deferred_event = false;
/*     */     } 
/*     */   }
/*     */   
/*     */   public boolean filterEvent(LinuxEvent event) {
/* 355 */     switch (event.getType()) {
/*     */       case 2:
/*     */       case 3:
/* 358 */         handleKeyEvent(event.getKeyAddress(), event.getKeyTime(), event.getKeyType(), event.getKeyKeyCode(), event.getKeyState());
/* 359 */         return true;
/*     */     } 
/*     */ 
/*     */     
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\LinuxKeyboard.class
