...
/* 2557 */     return ((this.glVertexAttribParameteriAMD = GLContext.getFunctionAddress("glVertexAttribParameteriAMD")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean AMD_multi_draw_indirect_initNativeFunctionAddresses() {
/* 2562 */     return (((this.glMultiDrawArraysIndirectAMD = GLContext.getFunctionAddress("glMultiDrawArraysIndirectAMD")) != 0L)) & (((this.glMultiDrawElementsIndirectAMD = GLContext.getFunctionAddress("glMultiDrawElementsIndirectAMD")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean AMD_name_gen_delete_initNativeFunctionAddresses() {
/* 2568 */     return (((this.glGenNamesAMD = GLContext.getFunctionAddress("glGenNamesAMD")) != 0L)) & (((this.glDeleteNamesAMD = GLContext.getFunctionAddress("glDeleteNamesAMD")) != 0L)) & (((this.glIsNameAMD = GLContext.getFunctionAddress("glIsNameAMD")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2633 */     return (((this.glBufferParameteriAPPLE = GLContext.getFunctionAddress("glBufferParameteriAPPLE")) != 0L)) & (((this.glFlushMappedBufferRangeAPPLE = GLContext.getFunctionAddress("glFlushMappedBufferRangeAPPLE")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean APPLE_object_purgeable_initNativeFunctionAddresses() {
/* 2639 */     return (((this.glObjectPurgeableAPPLE = GLContext.getFunctionAddress("glObjectPurgeableAPPLE")) != 0L)) & (((this.glObjectUnpurgeableAPPLE = GLContext.getFunctionAddress("glObjectUnpurgeableAPPLE")) != 0L)) & (((this.glGetObjectParameterivAPPLE = GLContext.getFunctionAddress("glGetObjectParameterivAPPLE")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2660 */     return (((this.glVertexArrayRangeAPPLE = GLContext.getFunctionAddress("glVertexArrayRangeAPPLE")) != 0L)) & (((this.glFlushVertexArrayRangeAPPLE = GLContext.getFunctionAddress("glFlushVertexArrayRangeAPPLE")) != 0L)) & (((this.glVertexArrayParameteriAPPLE = GLContext.getFunctionAddress("glVertexArrayParameteriAPPLE")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2687 */     return ((this.glMemoryBarrierByRegion = GLContext.getFunctionAddress("glMemoryBarrierByRegion")) != 0L);
/*      */   }
/*      */ 
/*      */   
...
/* 2759 */     return (((this.glClearTexImage = GLContext.getFunctionAddress("glClearTexImage")) != 0L)) & (((this.glClearTexSubImage = GLContext.getFunctionAddress("glClearTexSubImage")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean ARB_clip_control_initNativeFunctionAddresses() {
/* 2765 */     return ((this.glClipControl = GLContext.getFunctionAddress("glClipControl")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ARB_color_buffer_float_initNativeFunctionAddresses() {
/* 2770 */     return ((this.glClampColorARB = GLContext.getFunctionAddress("glClampColorARB")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ARB_compute_shader_initNativeFunctionAddresses() {
/* 2775 */     return (((this.glDispatchCompute = GLContext.getFunctionAddress("glDispatchCompute")) != 0L)) & (((this.glDispatchComputeIndirect = GLContext.getFunctionAddress("glDispatchComputeIndirect")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean ARB_compute_variable_group_size_initNativeFunctionAddresses() {
/* 2781 */     return ((this.glDispatchComputeGroupSizeARB = GLContext.getFunctionAddress("glDispatchComputeGroupSizeARB")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ARB_copy_buffer_initNativeFunctionAddresses() {
/* 2786 */     return ((this.glCopyBufferSubData = GLContext.getFunctionAddress("glCopyBufferSubData")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ARB_copy_image_initNativeFunctionAddresses() {
/* 2791 */     return ((this.glCopyImageSubData = GLContext.getFunctionAddress("glCopyImageSubData")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ARB_debug_output_initNativeFunctionAddresses() {
/* 2796 */     return (((this.glDebugMessageControlARB = GLContext.getFunctionAddress("glDebugMessageControlARB")) != 0L)) & (((this.glDebugMessageInsertARB = GLContext.getFunctionAddress("glDebugMessageInsertARB")) != 0L)) & (((this.glDebugMessageCallbackARB = GLContext.getFunctionAddress("glDebugMessageCallbackARB")) != 0L) ? 1 : 0) & (((this.glGetDebugMessageLogARB = GLContext.getFunctionAddress("glGetDebugMessageLogARB")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2901 */     return ((this.glDrawBuffersARB = GLContext.getFunctionAddress("glDrawBuffersARB")) != 0L);
/*      */   }
/*      */ 
/*      */   
...
/* 2914 */     return (((this.glDrawElementsBaseVertex = GLContext.getFunctionAddress("glDrawElementsBaseVertex")) != 0L)) & (((this.glDrawRangeElementsBaseVertex = GLContext.getFunctionAddress("glDrawRangeElementsBaseVertex")) != 0L)) & (((this.glDrawElementsInstancedBaseVertex = GLContext.getFunctionAddress("glDrawElementsInstancedBaseVertex")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2973 */     return (((this.glGetProgramBinary = GLContext.getFunctionAddress("glGetProgramBinary")) != 0L)) & (((this.glProgramBinary = GLContext.getFunctionAddress("glProgramBinary")) != 0L)) & (((this.glProgramParameteri = GLContext.getFunctionAddress("glProgramParameteri")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3482 */     return ((this.glTextureView = GLContext.getFunctionAddress("glTextureView")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ARB_timer_query_initNativeFunctionAddresses() {
/* 3487 */     return (((this.glQueryCounter = GLContext.getFunctionAddress("glQueryCounter")) != 0L)) & (((this.glGetQueryObjecti64v = GLContext.getFunctionAddress("glGetQueryObjecti64v")) != 0L)) & (((this.glGetQueryObjectui64v = GLContext.getFunctionAddress("glGetQueryObjectui64v")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3709 */     return ((this.glDrawBuffersATI = GLContext.getFunctionAddress("glDrawBuffersATI")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean ATI_element_array_initNativeFunctionAddresses() {
/* 3714 */     return (((this.glElementPointerATI = GLContext.getFunctionAddress("glElementPointerATI")) != 0L)) & (((this.glDrawElementArrayATI = GLContext.getFunctionAddress("glDrawElementArrayATI")) != 0L)) & (((this.glDrawRangeElementArrayATI = GLContext.getFunctionAddress("glDrawRangeElementArrayATI")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3812 */     return (((this.glUniformBufferEXT = GLContext.getFunctionAddress("glUniformBufferEXT")) != 0L)) & (((this.glGetUniformBufferSizeEXT = GLContext.getFunctionAddress("glGetUniformBufferSizeEXT")) != 0L)) & (((this.glGetUniformOffsetEXT = GLContext.getFunctionAddress("glGetUniformOffsetEXT")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3819 */     return ((this.glBlendColorEXT = GLContext.getFunctionAddress("glBlendColorEXT")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean EXT_blend_equation_separate_initNativeFunctionAddresses() {
/* 3824 */     return ((this.glBlendEquationSeparateEXT = GLContext.getFunctionAddress("glBlendEquationSeparateEXT")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean EXT_blend_func_separate_initNativeFunctionAddresses() {
/* 3829 */     return ((this.glBlendFuncSeparateEXT = GLContext.getFunctionAddress("glBlendFuncSeparateEXT")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean EXT_blend_minmax_initNativeFunctionAddresses() {
/* 3834 */     return ((this.glBlendEquationEXT = GLContext.getFunctionAddress("glBlendEquationEXT")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean EXT_compiled_vertex_array_initNativeFunctionAddresses() {
/* 3839 */     return (((this.glLockArraysEXT = GLContext.getFunctionAddress("glLockArraysEXT")) != 0L)) & (((this.glUnlockArraysEXT = GLContext.getFunctionAddress("glUnlockArraysEXT")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean EXT_depth_bounds_test_initNativeFunctionAddresses() {
/* 3845 */     return ((this.glDepthBoundsEXT = GLContext.getFunctionAddress("glDepthBoundsEXT")) != 0L);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4082 */     return (((this.glDrawArraysInstancedEXT = GLContext.getFunctionAddress("glDrawArraysInstancedEXT")) != 0L)) & (((this.glDrawElementsInstancedEXT = GLContext.getFunctionAddress("glDrawElementsInstancedEXT")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean EXT_draw_range_elements_initNativeFunctionAddresses() {
/* 4088 */     return ((this.glDrawRangeElementsEXT = GLContext.getFunctionAddress("glDrawRangeElementsEXT")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean EXT_fog_coord_initNativeFunctionAddresses() {
/* 4093 */     return (((this.glFogCoordfEXT = GLContext.getFunctionAddress("glFogCoordfEXT")) != 0L)) & (((this.glFogCoorddEXT = GLContext.getFunctionAddress("glFogCoorddEXT")) != 0L)) & (((this.glFogCoordPointerEXT = GLContext.getFunctionAddress("glFogCoordPointerEXT")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4217 */     return (((this.glUseShaderProgramEXT = GLContext.getFunctionAddress("glUseShaderProgramEXT")) != 0L)) & (((this.glActiveProgramEXT = GLContext.getFunctionAddress("glActiveProgramEXT")) != 0L)) & (((this.glCreateShaderProgramEXT = GLContext.getFunctionAddress("glCreateShaderProgramEXT")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4577 */     return (((this.glDrawRangeElements = GLContext.getFunctionAddress("glDrawRangeElements")) != 0L)) & (((this.glTexImage3D = GLContext.getFunctionAddress("glTexImage3D")) != 0L)) & (((this.glTexSubImage3D = GLContext.getFunctionAddress("glTexSubImage3D")) != 0L) ? 1 : 0) & (((this.glCopyTexSubImage3D = GLContext.getFunctionAddress("glCopyTexSubImage3D")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5257 */     return ((this.glFrameTerminatorGREMEDY = GLContext.getFunctionAddress("glFrameTerminatorGREMEDY")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean GREMEDY_string_marker_initNativeFunctionAddresses() {
/* 5262 */     return ((this.glStringMarkerGREMEDY = GLContext.getFunctionAddress("glStringMarkerGREMEDY")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean INTEL_map_texture_initNativeFunctionAddresses() {
/* 5267 */     return (((this.glMapTexture2DINTEL = GLContext.getFunctionAddress("glMapTexture2DINTEL")) != 0L)) & (((this.glUnmapTexture2DINTEL = GLContext.getFunctionAddress("glUnmapTexture2DINTEL")) != 0L)) & (((this.glSyncTextureINTEL = GLContext.getFunctionAddress("glSyncTextureINTEL")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5320 */     return (((this.glBlendParameteriNV = GLContext.getFunctionAddress("glBlendParameteriNV")) != 0L)) & (((this.glBlendBarrierNV = GLContext.getFunctionAddress("glBlendBarrierNV")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean NV_conditional_render_initNativeFunctionAddresses() {
/* 5326 */     return (((this.glBeginConditionalRenderNV = GLContext.getFunctionAddress("glBeginConditionalRenderNV")) != 0L)) & (((this.glEndConditionalRenderNV = GLContext.getFunctionAddress("glEndConditionalRenderNV")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   private boolean NV_copy_image_initNativeFunctionAddresses() {
/* 5332 */     return ((this.glCopyImageSubDataNV = GLContext.getFunctionAddress("glCopyImageSubDataNV")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean NV_depth_buffer_float_initNativeFunctionAddresses() {
/* 5337 */     return (((this.glDepthRangedNV = GLContext.getFunctionAddress("glDepthRangedNV")) != 0L)) & (((this.glClearDepthdNV = GLContext.getFunctionAddress("glClearDepthdNV")) != 0L)) & (((this.glDepthBoundsdNV = GLContext.getFunctionAddress("glDepthBoundsdNV")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5390 */     return ((this.glRenderbufferStorageMultisampleCoverageNV = GLContext.getFunctionAddress("glRenderbufferStorageMultisampleCoverageNV")) != 0L);
/*      */   }
/*      */ 
/*      */   
/*      */   private boolean NV_geometry_program4_initNativeFunctionAddresses() {
/* 5395 */     return (((this.glProgramVertexLimitNV = GLContext.getFunctionAddress("glProgramVertexLimitNV")) != 0L)) & (((this.glFramebufferTextureEXT = GLContext.getFunctionAddress("glFramebufferTextureEXT")) != 0L)) & (((this.glFramebufferTextureLayerEXT = GLContext.getFunctionAddress("glFramebufferTextureLayerEXT")) != 0L) ? 1 : 0) & (((this.glFramebufferTextureFaceEXT = GLContext.getFunctionAddress("glFramebufferTextureFaceEXT")) != 0L) ? 1 : 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5619 */     return (((this.glCombinerStageParameterfvNV = GLContext.getFunctionAddress("glCombinerStageParameterfvNV")) != 0L)) & (((this.glGetCombinerStageParameterfvNV = GLContext.getFunctionAddress("glGetCombinerStageParameterfvNV")) != 0L));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* 5643 */     return ((this.glTextureBarrierNV = GLContext.getFunctionAddress("glTextureBarrierNV")) != 0L);
/*      */   }
/*      */ 
/*      */   
...
/* 5791 */     LWJGLUtil.log(extension + " was reported as available but an entry point is missing");
/* 5792 */     supported_extensions.remove(extension);
/*      */   }
/*      */   
/*      */   private Set<String> initAllStubs(boolean forwardCompatible) throws LWJGLException {
/* 5796 */     this.glGetError = GLContext.getFunctionAddress("glGetError");
/* 5797 */     this.glGetString = GLContext.getFunctionAddress("glGetString");
/* 5798 */     this.glGetIntegerv = GLContext.getFunctionAddress("glGetIntegerv");
/* 5799 */     this.glGetStringi = GLContext.getFunctionAddress("glGetStringi");
/* 5800 */     GLContext.setCapabilities(this);
/* 5801 */     Set<String> supported_extensions = new HashSet<String>(256);
/* 5802 */     int profileMask = GLContext.getSupportedExtensions(supported_extensions);
/* 5803 */     if (supported_extensions.contains("OpenGL31") && !supported_extensions.contains("GL_ARB_compatibility") && (profileMask & 0x2) == 0)
/* 5804 */       forwardCompatible = true; 
/* 5805 */     if (!GL11_initNativeFunctionAddresses(forwardCompatible))
/* 5806 */       throw new LWJGLException("GL11 not supported"); 
/* 5807 */     if (supported_extensions.contains("GL_ARB_fragment_program"))
/* 5808 */       supported_extensions.add("GL_ARB_program"); 
/* 5809 */     if (supported_extensions.contains("GL_ARB_pixel_buffer_object"))
/* 5810 */       supported_extensions.add("GL_ARB_buffer_object"); 
/* 5811 */     if (supported_extensions.contains("GL_ARB_vertex_buffer_object"))
/* 5812 */       supported_extensions.add("GL_ARB_buffer_object"); 
/* 5813 */     if (supported_extensions.contains("GL_ARB_vertex_program"))
/* 5814 */       supported_extensions.add("GL_ARB_program"); 
/* 5815 */     if (supported_extensions.contains("GL_EXT_pixel_buffer_object"))
/* 5816 */       supported_extensions.add("GL_ARB_buffer_object"); 
/* 5817 */     if (supported_extensions.contains("GL_NV_fragment_program"))
/* 5818 */       supported_extensions.add("GL_NV_program"); 
/* 5819 */     if (supported_extensions.contains("GL_NV_vertex_program"))
/* 5820 */       supported_extensions.add("GL_NV_program"); 
/* 5821 */     if ((supported_extensions.contains("GL_AMD_debug_output") || supported_extensions.contains("GL_AMDX_debug_output")) && !AMD_debug_output_initNativeFunctionAddresses()) {
/* 5822 */       remove(supported_extensions, "GL_AMDX_debug_output");
/* 5823 */       remove(supported_extensions, "GL_AMD_debug_output");
/*      */     } 
/* 5825 */     if (supported_extensions.contains("GL_AMD_draw_buffers_blend") && !AMD_draw_buffers_blend_initNativeFunctionAddresses())
/* 5826 */       remove(supported_extensions, "GL_AMD_draw_buffers_blend"); 
/* 5827 */     if (supported_extensions.contains("GL_AMD_interleaved_elements") && !AMD_interleaved_elements_initNativeFunctionAddresses())
/* 5828 */       remove(supported_extensions, "GL_AMD_interleaved_elements"); 
/* 5829 */     if (supported_extensions.contains("GL_AMD_multi_draw_indirect") && !AMD_multi_draw_indirect_initNativeFunctionAddresses())
/* 5830 */       remove(supported_extensions, "GL_AMD_multi_draw_indirect"); 
/* 5831 */     if (supported_extensions.contains("GL_AMD_name_gen_delete") && !AMD_name_gen_delete_initNativeFunctionAddresses())
/* 5832 */       remove(supported_extensions, "GL_AMD_name_gen_delete"); 
/* 5833 */     if (supported_extensions.contains("GL_AMD_performance_monitor") && !AMD_performance_monitor_initNativeFunctionAddresses())
/* 5834 */       remove(supported_extensions, "GL_AMD_performance_monitor"); 
/* 5835 */     if (supported_extensions.contains("GL_AMD_sample_positions") && !AMD_sample_positions_initNativeFunctionAddresses())
/* 5836 */       remove(supported_extensions, "GL_AMD_sample_positions"); 
/* 5837 */     if (supported_extensions.contains("GL_AMD_sparse_texture") && !AMD_sparse_texture_initNativeFunctionAddresses())
/* 5838 */       remove(supported_extensions, "GL_AMD_sparse_texture"); 
/* 5839 */     if (supported_extensions.contains("GL_AMD_stencil_operation_extended") && !AMD_stencil_operation_extended_initNativeFunctionAddresses())
/* 5840 */       remove(supported_extensions, "GL_AMD_stencil_operation_extended"); 
/* 5841 */     if (supported_extensions.contains("GL_AMD_vertex_shader_tessellator") && !AMD_vertex_shader_tessellator_initNativeFunctionAddresses())
/* 5842 */       remove(supported_extensions, "GL_AMD_vertex_shader_tessellator"); 
/* 5843 */     if (supported_extensions.contains("GL_APPLE_element_array") && !APPLE_element_array_initNativeFunctionAddresses())
/* 5844 */       remove(supported_extensions, "GL_APPLE_element_array"); 
/* 5845 */     if (supported_extensions.contains("GL_APPLE_fence") && !APPLE_fence_initNativeFunctionAddresses())
/* 5846 */       remove(supported_extensions, "GL_APPLE_fence"); 
/* 5847 */     if (supported_extensions.contains("GL_APPLE_flush_buffer_range") && !APPLE_flush_buffer_range_initNativeFunctionAddresses())
/* 5848 */       remove(supported_extensions, "GL_APPLE_flush_buffer_range"); 
/* 5849 */     if (supported_extensions.contains("GL_APPLE_object_purgeable") && !APPLE_object_purgeable_initNativeFunctionAddresses())
/* 5850 */       remove(supported_extensions, "GL_APPLE_object_purgeable"); 
/* 5851 */     if (supported_extensions.contains("GL_APPLE_texture_range") && !APPLE_texture_range_initNativeFunctionAddresses())
/* 5852 */       remove(supported_extensions, "GL_APPLE_texture_range"); 
/* 5853 */     if (supported_extensions.contains("GL_APPLE_vertex_array_object") && !APPLE_vertex_array_object_initNativeFunctionAddresses())
/* 5854 */       remove(supported_extensions, "GL_APPLE_vertex_array_object"); 
/* 5855 */     if (supported_extensions.contains("GL_APPLE_vertex_array_range") && !APPLE_vertex_array_range_initNativeFunctionAddresses())
/* 5856 */       remove(supported_extensions, "GL_APPLE_vertex_array_range"); 
/* 5857 */     if (supported_extensions.contains("GL_APPLE_vertex_program_evaluators") && !APPLE_vertex_program_evaluators_initNativeFunctionAddresses())
/* 5858 */       remove(supported_extensions, "GL_APPLE_vertex_program_evaluators"); 
/* 5859 */     if (supported_extensions.contains("GL_ARB_ES2_compatibility") && !ARB_ES2_compatibility_initNativeFunctionAddresses())
/* 5860 */       remove(supported_extensions, "GL_ARB_ES2_compatibility"); 
/* 5861 */     if (supported_extensions.contains("GL_ARB_ES3_1_compatibility") && !ARB_ES3_1_compatibility_initNativeFunctionAddresses())
/* 5862 */       remove(supported_extensions, "GL_ARB_ES3_1_compatibility"); 
/* 5863 */     if (supported_extensions.contains("GL_ARB_base_instance") && !ARB_base_instance_initNativeFunctionAddresses())
/* 5864 */       remove(supported_extensions, "GL_ARB_base_instance"); 
/* 5865 */     if (supported_extensions.contains("GL_ARB_bindless_texture") && !ARB_bindless_texture_initNativeFunctionAddresses())
/* 5866 */       remove(supported_extensions, "GL_ARB_bindless_texture"); 
/* 5867 */     if (supported_extensions.contains("GL_ARB_blend_func_extended") && !ARB_blend_func_extended_initNativeFunctionAddresses())
/* 5868 */       remove(supported_extensions, "GL_ARB_blend_func_extended"); 
/* 5869 */     if (supported_extensions.contains("GL_ARB_buffer_object") && !ARB_buffer_object_initNativeFunctionAddresses())
/* 5870 */       remove(supported_extensions, "GL_ARB_buffer_object"); 
/* 5871 */     if (supported_extensions.contains("GL_ARB_buffer_storage") && !ARB_buffer_storage_initNativeFunctionAddresses(supported_extensions))
/* 5872 */       remove(supported_extensions, "GL_ARB_buffer_storage"); 
/* 5873 */     if (supported_extensions.contains("GL_ARB_cl_event") && !ARB_cl_event_initNativeFunctionAddresses())
/* 5874 */       remove(supported_extensions, "GL_ARB_cl_event"); 
/* 5875 */     if (supported_extensions.contains("GL_ARB_clear_buffer_object") && !ARB_clear_buffer_object_initNativeFunctionAddresses(supported_extensions))
/* 5876 */       remove(supported_extensions, "GL_ARB_clear_buffer_object"); 
/* 5877 */     if (supported_extensions.contains("GL_ARB_clear_texture") && !ARB_clear_texture_initNativeFunctionAddresses())
/* 5878 */       remove(supported_extensions, "GL_ARB_clear_texture"); 
/* 5879 */     if (supported_extensions.contains("GL_ARB_clip_control") && !ARB_clip_control_initNativeFunctionAddresses())
/* 5880 */       remove(supported_extensions, "GL_ARB_clip_control"); 
/* 5881 */     if (supported_extensions.contains("GL_ARB_color_buffer_float") && !ARB_color_buffer_float_initNativeFunctionAddresses())
/* 5882 */       remove(supported_extensions, "GL_ARB_color_buffer_float"); 
/* 5883 */     if (supported_extensions.contains("GL_ARB_compute_shader") && !ARB_compute_shader_initNativeFunctionAddresses())
/* 5884 */       remove(supported_extensions, "GL_ARB_compute_shader"); 
/* 5885 */     if (supported_extensions.contains("GL_ARB_compute_variable_group_size") && !ARB_compute_variable_group_size_initNativeFunctionAddresses())
/* 5886 */       remove(supported_extensions, "GL_ARB_compute_variable_group_size"); 
/* 5887 */     if (supported_extensions.contains("GL_ARB_copy_buffer") && !ARB_copy_buffer_initNativeFunctionAddresses())
/* 5888 */       remove(supported_extensions, "GL_ARB_copy_buffer"); 
/* 5889 */     if (supported_extensions.contains("GL_ARB_copy_image") && !ARB_copy_image_initNativeFunctionAddresses())
/* 5890 */       remove(supported_extensions, "GL_ARB_copy_image"); 
/* 5891 */     if (supported_extensions.contains("GL_ARB_debug_output") && !ARB_debug_output_initNativeFunctionAddresses())
/* 5892 */       remove(supported_extensions, "GL_ARB_debug_output"); 
/* 5893 */     if (supported_extensions.contains("GL_ARB_direct_state_access") && !ARB_direct_state_access_initNativeFunctionAddresses())
/* 5894 */       remove(supported_extensions, "GL_ARB_direct_state_access"); 
/* 5895 */     if (supported_extensions.contains("GL_ARB_draw_buffers") && !ARB_draw_buffers_initNativeFunctionAddresses())
/* 5896 */       remove(supported_extensions, "GL_ARB_draw_buffers"); 
/* 5897 */     if (supported_extensions.contains("GL_ARB_draw_buffers_blend") && !ARB_draw_buffers_blend_initNativeFunctionAddresses())
/* 5898 */       remove(supported_extensions, "GL_ARB_draw_buffers_blend"); 
/* 5899 */     if (supported_extensions.contains("GL_ARB_draw_elements_base_vertex") && !ARB_draw_elements_base_vertex_initNativeFunctionAddresses())
/* 5900 */       remove(supported_extensions, "GL_ARB_draw_elements_base_vertex"); 
/* 5901 */     if (supported_extensions.contains("GL_ARB_draw_indirect") && !ARB_draw_indirect_initNativeFunctionAddresses())
/* 5902 */       remove(supported_extensions, "GL_ARB_draw_indirect"); 
/* 5903 */     if (supported_extensions.contains("GL_ARB_draw_instanced") && !ARB_draw_instanced_initNativeFunctionAddresses())
/* 5904 */       remove(supported_extensions, "GL_ARB_draw_instanced"); 
/* 5905 */     if (supported_extensions.contains("GL_ARB_framebuffer_no_attachments") && !ARB_framebuffer_no_attachments_initNativeFunctionAddresses(supported_extensions))
/* 5906 */       remove(supported_extensions, "GL_ARB_framebuffer_no_attachments"); 
/* 5907 */     if (supported_extensions.contains("GL_ARB_framebuffer_object") && !ARB_framebuffer_object_initNativeFunctionAddresses())
/* 5908 */       remove(supported_extensions, "GL_ARB_framebuffer_object"); 
/* 5909 */     if (supported_extensions.contains("GL_ARB_geometry_shader4") && !ARB_geometry_shader4_initNativeFunctionAddresses())
/* 5910 */       remove(supported_extensions, "GL_ARB_geometry_shader4"); 
/* 5911 */     if (supported_extensions.contains("GL_ARB_get_program_binary") && !ARB_get_program_binary_initNativeFunctionAddresses())
/* 5912 */       remove(supported_extensions, "GL_ARB_get_program_binary"); 
/* 5913 */     if (supported_extensions.contains("GL_ARB_get_texture_sub_image") && !ARB_get_texture_sub_image_initNativeFunctionAddresses())
/* 5914 */       remove(supported_extensions, "GL_ARB_get_texture_sub_image"); 
/* 5915 */     if (supported_extensions.contains("GL_ARB_gpu_shader_fp64") && !ARB_gpu_shader_fp64_initNativeFunctionAddresses(supported_extensions))
/* 5916 */       remove(supported_extensions, "GL_ARB_gpu_shader_fp64"); 
/* 5917 */     if (supported_extensions.contains("GL_ARB_imaging") && !ARB_imaging_initNativeFunctionAddresses(forwardCompatible))
/* 5918 */       remove(supported_extensions, "GL_ARB_imaging"); 
/* 5919 */     if (supported_extensions.contains("GL_ARB_indirect_parameters") && !ARB_indirect_parameters_initNativeFunctionAddresses())
/* 5920 */       remove(supported_extensions, "GL_ARB_indirect_parameters"); 
/* 5921 */     if (supported_extensions.contains("GL_ARB_instanced_arrays") && !ARB_instanced_arrays_initNativeFunctionAddresses())
/* 5922 */       remove(supported_extensions, "GL_ARB_instanced_arrays"); 
/* 5923 */     if (supported_extensions.contains("GL_ARB_internalformat_query") && !ARB_internalformat_query_initNativeFunctionAddresses())
/* 5924 */       remove(supported_extensions, "GL_ARB_internalformat_query"); 
/* 5925 */     if (supported_extensions.contains("GL_ARB_internalformat_query2") && !ARB_internalformat_query2_initNativeFunctionAddresses())
/* 5926 */       remove(supported_extensions, "GL_ARB_internalformat_query2"); 
/* 5927 */     if (supported_extensions.contains("GL_ARB_invalidate_subdata") && !ARB_invalidate_subdata_initNativeFunctionAddresses())
/* 5928 */       remove(supported_extensions, "GL_ARB_invalidate_subdata"); 
/* 5929 */     if (supported_extensions.contains("GL_ARB_map_buffer_range") && !ARB_map_buffer_range_initNativeFunctionAddresses())
/* 5930 */       remove(supported_extensions, "GL_ARB_map_buffer_range"); 
/* 5931 */     if (supported_extensions.contains("GL_ARB_matrix_palette") && !ARB_matrix_palette_initNativeFunctionAddresses())
/* 5932 */       remove(supported_extensions, "GL_ARB_matrix_palette"); 
/* 5933 */     if (supported_extensions.contains("GL_ARB_multi_bind") && !ARB_multi_bind_initNativeFunctionAddresses())
/* 5934 */       remove(supported_extensions, "GL_ARB_multi_bind"); 
/* 5935 */     if (supported_extensions.contains("GL_ARB_multi_draw_indirect") && !ARB_multi_draw_indirect_initNativeFunctionAddresses())
/* 5936 */       remove(supported_extensions, "GL_ARB_multi_draw_indirect"); 
/* 5937 */     if (supported_extensions.contains("GL_ARB_multisample") && !ARB_multisample_initNativeFunctionAddresses())
/* 5938 */       remove(supported_extensions, "GL_ARB_multisample"); 
/* 5939 */     if (supported_extensions.contains("GL_ARB_multitexture") && !ARB_multitexture_initNativeFunctionAddresses())
/* 5940 */       remove(supported_extensions, "GL_ARB_multitexture"); 
/* 5941 */     if (supported_extensions.contains("GL_ARB_occlusion_query") && !ARB_occlusion_query_initNativeFunctionAddresses())
/* 5942 */       remove(supported_extensions, "GL_ARB_occlusion_query"); 
/* 5943 */     if (supported_extensions.contains("GL_ARB_point_parameters") && !ARB_point_parameters_initNativeFunctionAddresses())
/* 5944 */       remove(supported_extensions, "GL_ARB_point_parameters"); 
/* 5945 */     if (supported_extensions.contains("GL_ARB_program") && !ARB_program_initNativeFunctionAddresses())
/* 5946 */       remove(supported_extensions, "GL_ARB_program"); 
/* 5947 */     if (supported_extensions.contains("GL_ARB_program_interface_query") && !ARB_program_interface_query_initNativeFunctionAddresses())
/* 5948 */       remove(supported_extensions, "GL_ARB_program_interface_query"); 
/* 5949 */     if (supported_extensions.contains("GL_ARB_provoking_vertex") && !ARB_provoking_vertex_initNativeFunctionAddresses())
/* 5950 */       remove(supported_extensions, "GL_ARB_provoking_vertex"); 
/* 5951 */     if (supported_extensions.contains("GL_ARB_robustness") && !ARB_robustness_initNativeFunctionAddresses(forwardCompatible, supported_extensions))
/* 5952 */       remove(supported_extensions, "GL_ARB_robustness"); 
/* 5953 */     if (supported_extensions.contains("GL_ARB_sample_shading") && !ARB_sample_shading_initNativeFunctionAddresses())
/* 5954 */       remove(supported_extensions, "GL_ARB_sample_shading"); 
/* 5955 */     if (supported_extensions.contains("GL_ARB_sampler_objects") && !ARB_sampler_objects_initNativeFunctionAddresses())
/* 5956 */       remove(supported_extensions, "GL_ARB_sampler_objects"); 
/* 5957 */     if (supported_extensions.contains("GL_ARB_separate_shader_objects") && !ARB_separate_shader_objects_initNativeFunctionAddresses())
/* 5958 */       remove(supported_extensions, "GL_ARB_separate_shader_objects"); 
/* 5959 */     if (supported_extensions.contains("GL_ARB_shader_atomic_counters") && !ARB_shader_atomic_counters_initNativeFunctionAddresses())
/* 5960 */       remove(supported_extensions, "GL_ARB_shader_atomic_counters"); 
/* 5961 */     if (supported_extensions.contains("GL_ARB_shader_image_load_store") && !ARB_shader_image_load_store_initNativeFunctionAddresses())
/* 5962 */       remove(supported_extensions, "GL_ARB_shader_image_load_store"); 
/* 5963 */     if (supported_extensions.contains("GL_ARB_shader_objects") && !ARB_shader_objects_initNativeFunctionAddresses())
/* 5964 */       remove(supported_extensions, "GL_ARB_shader_objects"); 
/* 5965 */     if (supported_extensions.contains("GL_ARB_shader_storage_buffer_object") && !ARB_shader_storage_buffer_object_initNativeFunctionAddresses())
/* 5966 */       remove(supported_extensions, "GL_ARB_shader_storage_buffer_object"); 
/* 5967 */     if (supported_extensions.contains("GL_ARB_shader_subroutine") && !ARB_shader_subroutine_initNativeFunctionAddresses())
/* 5968 */       remove(supported_extensions, "GL_ARB_shader_subroutine"); 
/* 5969 */     if (supported_extensions.contains("GL_ARB_shading_language_include") && !ARB_shading_language_include_initNativeFunctionAddresses())
/* 5970 */       remove(supported_extensions, "GL_ARB_shading_language_include"); 
/* 5971 */     if (supported_extensions.contains("GL_ARB_sparse_buffer") && !ARB_sparse_buffer_initNativeFunctionAddresses())
/* 5972 */       remove(supported_extensions, "GL_ARB_sparse_buffer"); 
/* 5973 */     if (supported_extensions.contains("GL_ARB_sparse_texture") && !ARB_sparse_texture_initNativeFunctionAddresses(supported_extensions))
/* 5974 */       remove(supported_extensions, "GL_ARB_sparse_texture"); 
/* 5975 */     if (supported_extensions.contains("GL_ARB_sync") && !ARB_sync_initNativeFunctionAddresses())
/* 5976 */       remove(supported_extensions, "GL_ARB_sync"); 
/* 5977 */     if (supported_extensions.contains("GL_ARB_tessellation_shader") && !ARB_tessellation_shader_initNativeFunctionAddresses())
/* 5978 */       remove(supported_extensions, "GL_ARB_tessellation_shader"); 
/* 5979 */     if (supported_extensions.contains("GL_ARB_texture_barrier") && !ARB_texture_barrier_initNativeFunctionAddresses())
/* 5980 */       remove(supported_extensions, "GL_ARB_texture_barrier"); 
/* 5981 */     if (supported_extensions.contains("GL_ARB_texture_buffer_object") && !ARB_texture_buffer_object_initNativeFunctionAddresses())
/* 5982 */       remove(supported_extensions, "GL_ARB_texture_buffer_object"); 
/* 5983 */     if (supported_extensions.contains("GL_ARB_texture_buffer_range") && !ARB_texture_buffer_range_initNativeFunctionAddresses(supported_extensions))
/* 5984 */       remove(supported_extensions, "GL_ARB_texture_buffer_range"); 
/* 5985 */     if (supported_extensions.contains("GL_ARB_texture_compression") && !ARB_texture_compression_initNativeFunctionAddresses())
/* 5986 */       remove(supported_extensions, "GL_ARB_texture_compression"); 
/* 5987 */     if (supported_extensions.contains("GL_ARB_texture_multisample") && !ARB_texture_multisample_initNativeFunctionAddresses())
/* 5988 */       remove(supported_extensions, "GL_ARB_texture_multisample"); 
/* 5989 */     if ((supported_extensions.contains("GL_ARB_texture_storage") || supported_extensions.contains("GL_EXT_texture_storage")) && !ARB_texture_storage_initNativeFunctionAddresses(supported_extensions)) {
/* 5990 */       remove(supported_extensions, "GL_EXT_texture_storage");
/* 5991 */       remove(supported_extensions, "GL_ARB_texture_storage");
/*      */     } 
/* 5993 */     if (supported_extensions.contains("GL_ARB_texture_storage_multisample") && !ARB_texture_storage_multisample_initNativeFunctionAddresses(supported_extensions))
/* 5994 */       remove(supported_extensions, "GL_ARB_texture_storage_multisample"); 
/* 5995 */     if (supported_extensions.contains("GL_ARB_texture_view") && !ARB_texture_view_initNativeFunctionAddresses())
/* 5996 */       remove(supported_extensions, "GL_ARB_texture_view"); 
/* 5997 */     if (supported_extensions.contains("GL_ARB_timer_query") && !ARB_timer_query_initNativeFunctionAddresses())
/* 5998 */       remove(supported_extensions, "GL_ARB_timer_query"); 
/* 5999 */     if (supported_extensions.contains("GL_ARB_transform_feedback2") && !ARB_transform_feedback2_initNativeFunctionAddresses())
/* 6000 */       remove(supported_extensions, "GL_ARB_transform_feedback2"); 
/* 6001 */     if (supported_extensions.contains("GL_ARB_transform_feedback3") && !ARB_transform_feedback3_initNativeFunctionAddresses())
/* 6002 */       remove(supported_extensions, "GL_ARB_transform_feedback3"); 
/* 6003 */     if (supported_extensions.contains("GL_ARB_transform_feedback_instanced") && !ARB_transform_feedback_instanced_initNativeFunctionAddresses())
/* 6004 */       remove(supported_extensions, "GL_ARB_transform_feedback_instanced"); 
/* 6005 */     if (supported_extensions.contains("GL_ARB_transpose_matrix") && !ARB_transpose_matrix_initNativeFunctionAddresses())
/* 6006 */       remove(supported_extensions, "GL_ARB_transpose_matrix"); 
/* 6007 */     if (supported_extensions.contains("GL_ARB_uniform_buffer_object") && !ARB_uniform_buffer_object_initNativeFunctionAddresses())
/* 6008 */       remove(supported_extensions, "GL_ARB_uniform_buffer_object"); 
/* 6009 */     if (supported_extensions.contains("GL_ARB_vertex_array_object") && !ARB_vertex_array_object_initNativeFunctionAddresses())
/* 6010 */       remove(supported_extensions, "GL_ARB_vertex_array_object"); 
/* 6011 */     if (supported_extensions.contains("GL_ARB_vertex_attrib_64bit") && !ARB_vertex_attrib_64bit_initNativeFunctionAddresses(supported_extensions))
/* 6012 */       remove(supported_extensions, "GL_ARB_vertex_attrib_64bit"); 
/* 6013 */     if (supported_extensions.contains("GL_ARB_vertex_attrib_binding") && !ARB_vertex_attrib_binding_initNativeFunctionAddresses())
/* 6014 */       remove(supported_extensions, "GL_ARB_vertex_attrib_binding"); 
/* 6015 */     if (supported_extensions.contains("GL_ARB_vertex_blend") && !ARB_vertex_blend_initNativeFunctionAddresses())
/* 6016 */       remove(supported_extensions, "GL_ARB_vertex_blend"); 
/* 6017 */     if (supported_extensions.contains("GL_ARB_vertex_program") && !ARB_vertex_program_initNativeFunctionAddresses())
/* 6018 */       remove(supported_extensions, "GL_ARB_vertex_program"); 
/* 6019 */     if (supported_extensions.contains("GL_ARB_vertex_shader") && !ARB_vertex_shader_initNativeFunctionAddresses())
/* 6020 */       remove(supported_extensions, "GL_ARB_vertex_shader"); 
/* 6021 */     if (supported_extensions.contains("GL_ARB_vertex_type_2_10_10_10_rev") && !ARB_vertex_type_2_10_10_10_rev_initNativeFunctionAddresses())
/* 6022 */       remove(supported_extensions, "GL_ARB_vertex_type_2_10_10_10_rev"); 
/* 6023 */     if (supported_extensions.contains("GL_ARB_viewport_array") && !ARB_viewport_array_initNativeFunctionAddresses())
/* 6024 */       remove(supported_extensions, "GL_ARB_viewport_array"); 
/* 6025 */     if (supported_extensions.contains("GL_ARB_window_pos") && !ARB_window_pos_initNativeFunctionAddresses(forwardCompatible))
/* 6026 */       remove(supported_extensions, "GL_ARB_window_pos"); 
/* 6027 */     if (supported_extensions.contains("GL_ATI_draw_buffers") && !ATI_draw_buffers_initNativeFunctionAddresses())
/* 6028 */       remove(supported_extensions, "GL_ATI_draw_buffers"); 
/* 6029 */     if (supported_extensions.contains("GL_ATI_element_array") && !ATI_element_array_initNativeFunctionAddresses())
/* 6030 */       remove(supported_extensions, "GL_ATI_element_array"); 
/* 6031 */     if (supported_extensions.contains("GL_ATI_envmap_bumpmap") && !ATI_envmap_bumpmap_initNativeFunctionAddresses())
/* 6032 */       remove(supported_extensions, "GL_ATI_envmap_bumpmap"); 
/* 6033 */     if (supported_extensions.contains("GL_ATI_fragment_shader") && !ATI_fragment_shader_initNativeFunctionAddresses())
/* 6034 */       remove(supported_extensions, "GL_ATI_fragment_shader"); 
/* 6035 */     if (supported_extensions.contains("GL_ATI_map_object_buffer") && !ATI_map_object_buffer_initNativeFunctionAddresses())
/* 6036 */       remove(supported_extensions, "GL_ATI_map_object_buffer"); 
/* 6037 */     if (supported_extensions.contains("GL_ATI_pn_triangles") && !ATI_pn_triangles_initNativeFunctionAddresses())
/* 6038 */       remove(supported_extensions, "GL_ATI_pn_triangles"); 
/* 6039 */     if (supported_extensions.contains("GL_ATI_separate_stencil") && !ATI_separate_stencil_initNativeFunctionAddresses())
/* 6040 */       remove(supported_extensions, "GL_ATI_separate_stencil"); 
/* 6041 */     if (supported_extensions.contains("GL_ATI_vertex_array_object") && !ATI_vertex_array_object_initNativeFunctionAddresses())
/* 6042 */       remove(supported_extensions, "GL_ATI_vertex_array_object"); 
/* 6043 */     if (supported_extensions.contains("GL_ATI_vertex_attrib_array_object") && !ATI_vertex_attrib_array_object_initNativeFunctionAddresses())
/* 6044 */       remove(supported_extensions, "GL_ATI_vertex_attrib_array_object"); 
/* 6045 */     if (supported_extensions.contains("GL_ATI_vertex_streams") && !ATI_vertex_streams_initNativeFunctionAddresses())
/* 6046 */       remove(supported_extensions, "GL_ATI_vertex_streams"); 
/* 6047 */     if (supported_extensions.contains("GL_EXT_bindable_uniform") && !EXT_bindable_uniform_initNativeFunctionAddresses())
/* 6048 */       remove(supported_extensions, "GL_EXT_bindable_uniform"); 
/* 6049 */     if (supported_extensions.contains("GL_EXT_blend_color") && !EXT_blend_color_initNativeFunctionAddresses())
/* 6050 */       remove(supported_extensions, "GL_EXT_blend_color"); 
/* 6051 */     if (supported_extensions.contains("GL_EXT_blend_equation_separate") && !EXT_blend_equation_separate_initNativeFunctionAddresses())
/* 6052 */       remove(supported_extensions, "GL_EXT_blend_equation_separate"); 
/* 6053 */     if (supported_extensions.contains("GL_EXT_blend_func_separate") && !EXT_blend_func_separate_initNativeFunctionAddresses())
/* 6054 */       remove(supported_extensions, "GL_EXT_blend_func_separate"); 
/* 6055 */     if (supported_extensions.contains("GL_EXT_blend_minmax") && !EXT_blend_minmax_initNativeFunctionAddresses())
/* 6056 */       remove(supported_extensions, "GL_EXT_blend_minmax"); 
/* 6057 */     if (supported_extensions.contains("GL_EXT_compiled_vertex_array") && !EXT_compiled_vertex_array_initNativeFunctionAddresses())
/* 6058 */       remove(supported_extensions, "GL_EXT_compiled_vertex_array"); 
/* 6059 */     if (supported_extensions.contains("GL_EXT_depth_bounds_test") && !EXT_depth_bounds_test_initNativeFunctionAddresses())
/* 6060 */       remove(supported_extensions, "GL_EXT_depth_bounds_test"); 
/* 6061 */     supported_extensions.add("GL_EXT_direct_state_access");
/* 6062 */     if (supported_extensions.contains("GL_EXT_direct_state_access") && !EXT_direct_state_access_initNativeFunctionAddresses(forwardCompatible, supported_extensions))
/* 6063 */       remove(supported_extensions, "GL_EXT_direct_state_access"); 
/* 6064 */     if (supported_extensions.contains("GL_EXT_draw_buffers2") && !EXT_draw_buffers2_initNativeFunctionAddresses())
/* 6065 */       remove(supported_extensions, "GL_EXT_draw_buffers2"); 
/* 6066 */     if (supported_extensions.contains("GL_EXT_draw_instanced") && !EXT_draw_instanced_initNativeFunctionAddresses())
/* 6067 */       remove(supported_extensions, "GL_EXT_draw_instanced"); 
/* 6068 */     if (supported_extensions.contains("GL_EXT_draw_range_elements") && !EXT_draw_range_elements_initNativeFunctionAddresses())
/* 6069 */       remove(supported_extensions, "GL_EXT_draw_range_elements"); 
/* 6070 */     if (supported_extensions.contains("GL_EXT_fog_coord") && !EXT_fog_coord_initNativeFunctionAddresses())
/* 6071 */       remove(supported_extensions, "GL_EXT_fog_coord"); 
/* 6072 */     if (supported_extensions.contains("GL_EXT_framebuffer_blit") && !EXT_framebuffer_blit_initNativeFunctionAddresses())
/* 6073 */       remove(supported_extensions, "GL_EXT_framebuffer_blit"); 
/* 6074 */     if (supported_extensions.contains("GL_EXT_framebuffer_multisample") && !EXT_framebuffer_multisample_initNativeFunctionAddresses())
/* 6075 */       remove(supported_extensions, "GL_EXT_framebuffer_multisample"); 
/* 6076 */     if (supported_extensions.contains("GL_EXT_framebuffer_object") && !EXT_framebuffer_object_initNativeFunctionAddresses())
/* 6077 */       remove(supported_extensions, "GL_EXT_framebuffer_object"); 
/* 6078 */     if (supported_extensions.contains("GL_EXT_geometry_shader4") && !EXT_geometry_shader4_initNativeFunctionAddresses())
/* 6079 */       remove(supported_extensions, "GL_EXT_geometry_shader4"); 
/* 6080 */     if (supported_extensions.contains("GL_EXT_gpu_program_parameters") && !EXT_gpu_program_parameters_initNativeFunctionAddresses())
/* 6081 */       remove(supported_extensions, "GL_EXT_gpu_program_parameters"); 
/* 6082 */     if (supported_extensions.contains("GL_EXT_gpu_shader4") && !EXT_gpu_shader4_initNativeFunctionAddresses())
/* 6083 */       remove(supported_extensions, "GL_EXT_gpu_shader4"); 
/* 6084 */     if (supported_extensions.contains("GL_EXT_multi_draw_arrays") && !EXT_multi_draw_arrays_initNativeFunctionAddresses())
/* 6085 */       remove(supported_extensions, "GL_EXT_multi_draw_arrays"); 
/* 6086 */     if (supported_extensions.contains("GL_EXT_paletted_texture") && !EXT_paletted_texture_initNativeFunctionAddresses())
/* 6087 */       remove(supported_extensions, "GL_EXT_paletted_texture"); 
/* 6088 */     if (supported_extensions.contains("GL_EXT_point_parameters") && !EXT_point_parameters_initNativeFunctionAddresses())
/* 6089 */       remove(supported_extensions, "GL_EXT_point_parameters"); 
/* 6090 */     if (supported_extensions.contains("GL_EXT_provoking_vertex") && !EXT_provoking_vertex_initNativeFunctionAddresses())
/* 6091 */       remove(supported_extensions, "GL_EXT_provoking_vertex"); 
/* 6092 */     if (supported_extensions.contains("GL_EXT_secondary_color") && !EXT_secondary_color_initNativeFunctionAddresses())
/* 6093 */       remove(supported_extensions, "GL_EXT_secondary_color"); 
/* 6094 */     if (supported_extensions.contains("GL_EXT_separate_shader_objects") && !EXT_separate_shader_objects_initNativeFunctionAddresses())
/* 6095 */       remove(supported_extensions, "GL_EXT_separate_shader_objects"); 
/* 6096 */     if (supported_extensions.contains("GL_EXT_shader_image_load_store") && !EXT_shader_image_load_store_initNativeFunctionAddresses())
/* 6097 */       remove(supported_extensions, "GL_EXT_shader_image_load_store"); 
/* 6098 */     if (supported_extensions.contains("GL_EXT_stencil_clear_tag") && !EXT_stencil_clear_tag_initNativeFunctionAddresses())
/* 6099 */       remove(supported_extensions, "GL_EXT_stencil_clear_tag"); 
/* 6100 */     if (supported_extensions.contains("GL_EXT_stencil_two_side") && !EXT_stencil_two_side_initNativeFunctionAddresses())
/* 6101 */       remove(supported_extensions, "GL_EXT_stencil_two_side"); 
/* 6102 */     if (supported_extensions.contains("GL_EXT_texture_array") && !EXT_texture_array_initNativeFunctionAddresses())
/* 6103 */       remove(supported_extensions, "GL_EXT_texture_array"); 
/* 6104 */     if (supported_extensions.contains("GL_EXT_texture_buffer_object") && !EXT_texture_buffer_object_initNativeFunctionAddresses())
/* 6105 */       remove(supported_extensions, "GL_EXT_texture_buffer_object"); 
/* 6106 */     if (supported_extensions.contains("GL_EXT_texture_integer") && !EXT_texture_integer_initNativeFunctionAddresses())
/* 6107 */       remove(supported_extensions, "GL_EXT_texture_integer"); 
/* 6108 */     if (supported_extensions.contains("GL_EXT_timer_query") && !EXT_timer_query_initNativeFunctionAddresses())
/* 6109 */       remove(supported_extensions, "GL_EXT_timer_query"); 
/* 6110 */     if (supported_extensions.contains("GL_EXT_transform_feedback") && !EXT_transform_feedback_initNativeFunctionAddresses())
/* 6111 */       remove(supported_extensions, "GL_EXT_transform_feedback"); 
/* 6112 */     if (supported_extensions.contains("GL_EXT_vertex_attrib_64bit") && !EXT_vertex_attrib_64bit_initNativeFunctionAddresses(supported_extensions))
/* 6113 */       remove(supported_extensions, "GL_EXT_vertex_attrib_64bit"); 
/* 6114 */     if (supported_extensions.contains("GL_EXT_vertex_shader") && !EXT_vertex_shader_initNativeFunctionAddresses())
/* 6115 */       remove(supported_extensions, "GL_EXT_vertex_shader"); 
/* 6116 */     if (supported_extensions.contains("GL_EXT_vertex_weighting") && !EXT_vertex_weighting_initNativeFunctionAddresses())
/* 6117 */       remove(supported_extensions, "GL_EXT_vertex_weighting"); 
/* 6118 */     if (supported_extensions.contains("OpenGL12") && !GL12_initNativeFunctionAddresses())
/* 6119 */       remove(supported_extensions, "OpenGL12"); 
/* 6120 */     if (supported_extensions.contains("OpenGL13") && !GL13_initNativeFunctionAddresses(forwardCompatible))
/* 6121 */       remove(supported_extensions, "OpenGL13"); 
/* 6122 */     if (supported_extensions.contains("OpenGL14") && !GL14_initNativeFunctionAddresses(forwardCompatible))
/* 6123 */       remove(supported_extensions, "OpenGL14"); 
/* 6124 */     if (supported_extensions.contains("OpenGL15") && !GL15_initNativeFunctionAddresses())
/* 6125 */       remove(supported_extensions, "OpenGL15"); 
/* 6126 */     if (supported_extensions.contains("OpenGL20") && !GL20_initNativeFunctionAddresses())
/* 6127 */       remove(supported_extensions, "OpenGL20"); 
/* 6128 */     if (supported_extensions.contains("OpenGL21") && !GL21_initNativeFunctionAddresses())
/* 6129 */       remove(supported_extensions, "OpenGL21"); 
/* 6130 */     if (supported_extensions.contains("OpenGL30") && !GL30_initNativeFunctionAddresses())
/* 6131 */       remove(supported_extensions, "OpenGL30"); 
/* 6132 */     if (supported_extensions.contains("OpenGL31") && !GL31_initNativeFunctionAddresses())
/* 6133 */       remove(supported_extensions, "OpenGL31"); 
/* 6134 */     if (supported_extensions.contains("OpenGL32") && !GL32_initNativeFunctionAddresses())
/* 6135 */       remove(supported_extensions, "OpenGL32"); 
/* 6136 */     if (supported_extensions.contains("OpenGL33") && !GL33_initNativeFunctionAddresses(forwardCompatible))
/* 6137 */       remove(supported_extensions, "OpenGL33"); 
/* 6138 */     if (supported_extensions.contains("OpenGL40") && !GL40_initNativeFunctionAddresses())
/* 6139 */       remove(supported_extensions, "OpenGL40"); 
/* 6140 */     if (supported_extensions.contains("OpenGL41") && !GL41_initNativeFunctionAddresses())
/* 6141 */       remove(supported_extensions, "OpenGL41"); 
/* 6142 */     if (supported_extensions.contains("OpenGL42") && !GL42_initNativeFunctionAddresses())
/* 6143 */       remove(supported_extensions, "OpenGL42"); 
/* 6144 */     if (supported_extensions.contains("OpenGL43") && !GL43_initNativeFunctionAddresses())
/* 6145 */       remove(supported_extensions, "OpenGL43"); 
/* 6146 */     if (supported_extensions.contains("OpenGL44") && !GL44_initNativeFunctionAddresses())
/* 6147 */       remove(supported_extensions, "OpenGL44"); 
/* 6148 */     if (supported_extensions.contains("OpenGL45") && !GL45_initNativeFunctionAddresses())
/* 6149 */       remove(supported_extensions, "OpenGL45"); 
/* 6150 */     if (supported_extensions.contains("GL_GREMEDY_frame_terminator") && !GREMEDY_frame_terminator_initNativeFunctionAddresses())
/* 6151 */       remove(supported_extensions, "GL_GREMEDY_frame_terminator"); 
/* 6152 */     if (supported_extensions.contains("GL_GREMEDY_string_marker") && !GREMEDY_string_marker_initNativeFunctionAddresses())
/* 6153 */       remove(supported_extensions, "GL_GREMEDY_string_marker"); 
/* 6154 */     if (supported_extensions.contains("GL_INTEL_map_texture") && !INTEL_map_texture_initNativeFunctionAddresses())
/* 6155 */       remove(supported_extensions, "GL_INTEL_map_texture"); 
/* 6156 */     if (supported_extensions.contains("GL_KHR_debug") && !KHR_debug_initNativeFunctionAddresses())
/* 6157 */       remove(supported_extensions, "GL_KHR_debug"); 
/* 6158 */     if (supported_extensions.contains("GL_KHR_robustness") && !KHR_robustness_initNativeFunctionAddresses())
/* 6159 */       remove(supported_extensions, "GL_KHR_robustness"); 
/* 6160 */     if (supported_extensions.contains("GL_NV_bindless_multi_draw_indirect") && !NV_bindless_multi_draw_indirect_initNativeFunctionAddresses())
/* 6161 */       remove(supported_extensions, "GL_NV_bindless_multi_draw_indirect"); 
/* 6162 */     if (supported_extensions.contains("GL_NV_bindless_texture") && !NV_bindless_texture_initNativeFunctionAddresses())
/* 6163 */       remove(supported_extensions, "GL_NV_bindless_texture"); 
/* 6164 */     if (supported_extensions.contains("GL_NV_blend_equation_advanced") && !NV_blend_equation_advanced_initNativeFunctionAddresses())
/* 6165 */       remove(supported_extensions, "GL_NV_blend_equation_advanced"); 
/* 6166 */     if (supported_extensions.contains("GL_NV_conditional_render") && !NV_conditional_render_initNativeFunctionAddresses())
/* 6167 */       remove(supported_extensions, "GL_NV_conditional_render"); 
/* 6168 */     if (supported_extensions.contains("GL_NV_copy_image") && !NV_copy_image_initNativeFunctionAddresses())
/* 6169 */       remove(supported_extensions, "GL_NV_copy_image"); 
/* 6170 */     if (supported_extensions.contains("GL_NV_depth_buffer_float") && !NV_depth_buffer_float_initNativeFunctionAddresses())
/* 6171 */       remove(supported_extensions, "GL_NV_depth_buffer_float"); 
/* 6172 */     if (supported_extensions.contains("GL_NV_draw_texture") && !NV_draw_texture_initNativeFunctionAddresses())
/* 6173 */       remove(supported_extensions, "GL_NV_draw_texture"); 
/* 6174 */     if (supported_extensions.contains("GL_NV_evaluators") && !NV_evaluators_initNativeFunctionAddresses())
/* 6175 */       remove(supported_extensions, "GL_NV_evaluators"); 
/* 6176 */     if (supported_extensions.contains("GL_NV_explicit_multisample") && !NV_explicit_multisample_initNativeFunctionAddresses())
/* 6177 */       remove(supported_extensions, "GL_NV_explicit_multisample"); 
/* 6178 */     if (supported_extensions.contains("GL_NV_fence") && !NV_fence_initNativeFunctionAddresses())
/* 6179 */       remove(supported_extensions, "GL_NV_fence"); 
/* 6180 */     if (supported_extensions.contains("GL_NV_fragment_program") && !NV_fragment_program_initNativeFunctionAddresses())
/* 6181 */       remove(supported_extensions, "GL_NV_fragment_program"); 
/* 6182 */     if (supported_extensions.contains("GL_NV_framebuffer_multisample_coverage") && !NV_framebuffer_multisample_coverage_initNativeFunctionAddresses())
/* 6183 */       remove(supported_extensions, "GL_NV_framebuffer_multisample_coverage"); 
/* 6184 */     if (supported_extensions.contains("GL_NV_geometry_program4") && !NV_geometry_program4_initNativeFunctionAddresses())
/* 6185 */       remove(supported_extensions, "GL_NV_geometry_program4"); 
/* 6186 */     if (supported_extensions.contains("GL_NV_gpu_program4") && !NV_gpu_program4_initNativeFunctionAddresses())
/* 6187 */       remove(supported_extensions, "GL_NV_gpu_program4"); 
/* 6188 */     if (supported_extensions.contains("GL_NV_gpu_shader5") && !NV_gpu_shader5_initNativeFunctionAddresses(supported_extensions))
/* 6189 */       remove(supported_extensions, "GL_NV_gpu_shader5"); 
/* 6190 */     if (supported_extensions.contains("GL_NV_half_float") && !NV_half_float_initNativeFunctionAddresses(supported_extensions))
/* 6191 */       remove(supported_extensions, "GL_NV_half_float"); 
/* 6192 */     if (supported_extensions.contains("GL_NV_occlusion_query") && !NV_occlusion_query_initNativeFunctionAddresses())
/* 6193 */       remove(supported_extensions, "GL_NV_occlusion_query"); 
/* 6194 */     if (supported_extensions.contains("GL_NV_parameter_buffer_object") && !NV_parameter_buffer_object_initNativeFunctionAddresses())
/* 6195 */       remove(supported_extensions, "GL_NV_parameter_buffer_object"); 
/* 6196 */     if (supported_extensions.contains("GL_NV_path_rendering") && !NV_path_rendering_initNativeFunctionAddresses())
/* 6197 */       remove(supported_extensions, "GL_NV_path_rendering"); 
/* 6198 */     if (supported_extensions.contains("GL_NV_pixel_data_range") && !NV_pixel_data_range_initNativeFunctionAddresses())
/* 6199 */       remove(supported_extensions, "GL_NV_pixel_data_range"); 
/* 6200 */     if (supported_extensions.contains("GL_NV_point_sprite") && !NV_point_sprite_initNativeFunctionAddresses())
/* 6201 */       remove(supported_extensions, "GL_NV_point_sprite"); 
/* 6202 */     if (supported_extensions.contains("GL_NV_present_video") && !NV_present_video_initNativeFunctionAddresses())
/* 6203 */       remove(supported_extensions, "GL_NV_present_video"); 
/* 6204 */     supported_extensions.add("GL_NV_primitive_restart");
/* 6205 */     if (supported_extensions.contains("GL_NV_primitive_restart") && !NV_primitive_restart_initNativeFunctionAddresses())
/* 6206 */       remove(supported_extensions, "GL_NV_primitive_restart"); 
/* 6207 */     if (supported_extensions.contains("GL_NV_program") && !NV_program_initNativeFunctionAddresses())
/* 6208 */       remove(supported_extensions, "GL_NV_program"); 
/* 6209 */     if (supported_extensions.contains("GL_NV_register_combiners") && !NV_register_combiners_initNativeFunctionAddresses())
/* 6210 */       remove(supported_extensions, "GL_NV_register_combiners"); 
/* 6211 */     if (supported_extensions.contains("GL_NV_register_combiners2") && !NV_register_combiners2_initNativeFunctionAddresses())
/* 6212 */       remove(supported_extensions, "GL_NV_register_combiners2"); 
/* 6213 */     if (supported_extensions.contains("GL_NV_shader_buffer_load") && !NV_shader_buffer_load_initNativeFunctionAddresses())
/* 6214 */       remove(supported_extensions, "GL_NV_shader_buffer_load"); 
/* 6215 */     if (supported_extensions.contains("GL_NV_texture_barrier") && !NV_texture_barrier_initNativeFunctionAddresses())
/* 6216 */       remove(supported_extensions, "GL_NV_texture_barrier"); 
/* 6217 */     if (supported_extensions.contains("GL_NV_texture_multisample") && !NV_texture_multisample_initNativeFunctionAddresses())
/* 6218 */       remove(supported_extensions, "GL_NV_texture_multisample"); 
/* 6219 */     if (supported_extensions.contains("GL_NV_transform_feedback") && !NV_transform_feedback_initNativeFunctionAddresses())
/* 6220 */       remove(supported_extensions, "GL_NV_transform_feedback"); 
/* 6221 */     if (supported_extensions.contains("GL_NV_transform_feedback2") && !NV_transform_feedback2_initNativeFunctionAddresses())
/* 6222 */       remove(supported_extensions, "GL_NV_transform_feedback2"); 
/* 6223 */     if (supported_extensions.contains("GL_NV_vertex_array_range") && !NV_vertex_array_range_initNativeFunctionAddresses())
/* 6224 */       remove(supported_extensions, "GL_NV_vertex_array_range"); 
/* 6225 */     if (supported_extensions.contains("GL_NV_vertex_attrib_integer_64bit") && !NV_vertex_attrib_integer_64bit_initNativeFunctionAddresses(supported_extensions))
/* 6226 */       remove(supported_extensions, "GL_NV_vertex_attrib_integer_64bit"); 
/* 6227 */     if (supported_extensions.contains("GL_NV_vertex_buffer_unified_memory") && !NV_vertex_buffer_unified_memory_initNativeFunctionAddresses())
/* 6228 */       remove(supported_extensions, "GL_NV_vertex_buffer_unified_memory"); 
/* 6229 */     if (supported_extensions.contains("GL_NV_vertex_program") && !NV_vertex_program_initNativeFunctionAddresses())
/* 6230 */       remove(supported_extensions, "GL_NV_vertex_program"); 
/* 6231 */     if (supported_extensions.contains("GL_NV_video_capture") && !NV_video_capture_initNativeFunctionAddresses())
/* 6232 */       remove(supported_extensions, "GL_NV_video_capture"); 
/* 6233 */     return supported_extensions;
/*      */   }
/*      */ 
/*      */   
...
/* 6240 */     Set<String> supported_extensions = initAllStubs(forwardCompatible);
/* 6241 */     this.GL_AMD_blend_minmax_factor = supported_extensions.contains("GL_AMD_blend_minmax_factor");
/* 6242 */     this.GL_AMD_conservative_depth = supported_extensions.contains("GL_AMD_conservative_depth");
/* 6243 */     this.GL_AMD_debug_output = (supported_extensions.contains("GL_AMD_debug_output") || supported_extensions.contains("GL_AMDX_debug_output"));
/*      */     
/* 6245 */     this.GL_AMD_depth_clamp_separate = supported_extensions.contains("GL_AMD_depth_clamp_separate");
/* 6246 */     this.GL_AMD_draw_buffers_blend = supported_extensions.contains("GL_AMD_draw_buffers_blend");
/* 6247 */     this.GL_AMD_interleaved_elements = supported_extensions.contains("GL_AMD_interleaved_elements");
/* 6248 */     this.GL_AMD_multi_draw_indirect = supported_extensions.contains("GL_AMD_multi_draw_indirect");
/* 6249 */     this.GL_AMD_name_gen_delete = supported_extensions.contains("GL_AMD_name_gen_delete");
/* 6250 */     this.GL_AMD_performance_monitor = supported_extensions.contains("GL_AMD_performance_monitor");
/* 6251 */     this.GL_AMD_pinned_memory = supported_extensions.contains("GL_AMD_pinned_memory");
/* 6252 */     this.GL_AMD_query_buffer_object = supported_extensions.contains("GL_AMD_query_buffer_object");
/* 6253 */     this.GL_AMD_sample_positions = supported_extensions.contains("GL_AMD_sample_positions");
/* 6254 */     this.GL_AMD_seamless_cubemap_per_texture = supported_extensions.contains("GL_AMD_seamless_cubemap_per_texture");
/* 6255 */     this.GL_AMD_shader_atomic_counter_ops = supported_extensions.contains("GL_AMD_shader_atomic_counter_ops");
/* 6256 */     this.GL_AMD_shader_stencil_export = supported_extensions.contains("GL_AMD_shader_stencil_export");
/* 6257 */     this.GL_AMD_shader_trinary_minmax = supported_extensions.contains("GL_AMD_shader_trinary_minmax");
/* 6258 */     this.GL_AMD_sparse_texture = supported_extensions.contains("GL_AMD_sparse_texture");
/* 6259 */     this.GL_AMD_stencil_operation_extended = supported_extensions.contains("GL_AMD_stencil_operation_extended");
/* 6260 */     this.GL_AMD_texture_texture4 = supported_extensions.contains("GL_AMD_texture_texture4");
/* 6261 */     this.GL_AMD_transform_feedback3_lines_triangles = supported_extensions.contains("GL_AMD_transform_feedback3_lines_triangles");
/* 6262 */     this.GL_AMD_vertex_shader_layer = supported_extensions.contains("GL_AMD_vertex_shader_layer");
/* 6263 */     this.GL_AMD_vertex_shader_tessellator = supported_extensions.contains("GL_AMD_vertex_shader_tessellator");
/* 6264 */     this.GL_AMD_vertex_shader_viewport_index = supported_extensions.contains("GL_AMD_vertex_shader_viewport_index");
/* 6265 */     this.GL_APPLE_aux_depth_stencil = supported_extensions.contains("GL_APPLE_aux_depth_stencil");
/* 6266 */     this.GL_APPLE_client_storage = supported_extensions.contains("GL_APPLE_client_storage");
/* 6267 */     this.GL_APPLE_element_array = supported_extensions.contains("GL_APPLE_element_array");
/* 6268 */     this.GL_APPLE_fence = supported_extensions.contains("GL_APPLE_fence");
/* 6269 */     this.GL_APPLE_float_pixels = supported_extensions.contains("GL_APPLE_float_pixels");
/* 6270 */     this.GL_APPLE_flush_buffer_range = supported_extensions.contains("GL_APPLE_flush_buffer_range");
/* 6271 */     this.GL_APPLE_object_purgeable = supported_extensions.contains("GL_APPLE_object_purgeable");
/* 6272 */     this.GL_APPLE_packed_pixels = supported_extensions.contains("GL_APPLE_packed_pixels");
/* 6273 */     this.GL_APPLE_rgb_422 = supported_extensions.contains("GL_APPLE_rgb_422");
/* 6274 */     this.GL_APPLE_row_bytes = supported_extensions.contains("GL_APPLE_row_bytes");
/* 6275 */     this.GL_APPLE_texture_range = supported_extensions.contains("GL_APPLE_texture_range");
/* 6276 */     this.GL_APPLE_vertex_array_object = supported_extensions.contains("GL_APPLE_vertex_array_object");
/* 6277 */     this.GL_APPLE_vertex_array_range = supported_extensions.contains("GL_APPLE_vertex_array_range");
/* 6278 */     this.GL_APPLE_vertex_program_evaluators = supported_extensions.contains("GL_APPLE_vertex_program_evaluators");
/* 6279 */     this.GL_APPLE_ycbcr_422 = supported_extensions.contains("GL_APPLE_ycbcr_422");
/* 6280 */     this.GL_ARB_ES2_compatibility = supported_extensions.contains("GL_ARB_ES2_compatibility");
/* 6281 */     this.GL_ARB_ES3_1_compatibility = supported_extensions.contains("GL_ARB_ES3_1_compatibility");
/* 6282 */     this.GL_ARB_ES3_compatibility = supported_extensions.contains("GL_ARB_ES3_compatibility");
/* 6283 */     this.GL_ARB_arrays_of_arrays = supported_extensions.contains("GL_ARB_arrays_of_arrays");
/* 6284 */     this.GL_ARB_base_instance = supported_extensions.contains("GL_ARB_base_instance");
/* 6285 */     this.GL_ARB_bindless_texture = supported_extensions.contains("GL_ARB_bindless_texture");
/* 6286 */     this.GL_ARB_blend_func_extended = supported_extensions.contains("GL_ARB_blend_func_extended");
/* 6287 */     this.GL_ARB_buffer_storage = supported_extensions.contains("GL_ARB_buffer_storage");
/* 6288 */     this.GL_ARB_cl_event = supported_extensions.contains("GL_ARB_cl_event");
/* 6289 */     this.GL_ARB_clear_buffer_object = supported_extensions.contains("GL_ARB_clear_buffer_object");
/* 6290 */     this.GL_ARB_clear_texture = supported_extensions.contains("GL_ARB_clear_texture");
/* 6291 */     this.GL_ARB_clip_control = supported_extensions.contains("GL_ARB_clip_control");
/* 6292 */     this.GL_ARB_color_buffer_float = supported_extensions.contains("GL_ARB_color_buffer_float");
/* 6293 */     this.GL_ARB_compatibility = supported_extensions.contains("GL_ARB_compatibility");
/* 6294 */     this.GL_ARB_compressed_texture_pixel_storage = supported_extensions.contains("GL_ARB_compressed_texture_pixel_storage");
/* 6295 */     this.GL_ARB_compute_shader = supported_extensions.contains("GL_ARB_compute_shader");
/* 6296 */     this.GL_ARB_compute_variable_group_size = supported_extensions.contains("GL_ARB_compute_variable_group_size");
/* 6297 */     this.GL_ARB_conditional_render_inverted = supported_extensions.contains("GL_ARB_conditional_render_inverted");
/* 6298 */     this.GL_ARB_conservative_depth = supported_extensions.contains("GL_ARB_conservative_depth");
/* 6299 */     this.GL_ARB_copy_buffer = supported_extensions.contains("GL_ARB_copy_buffer");
/* 6300 */     this.GL_ARB_copy_image = supported_extensions.contains("GL_ARB_copy_image");
/* 6301 */     this.GL_ARB_cull_distance = supported_extensions.contains("GL_ARB_cull_distance");
/* 6302 */     this.GL_ARB_debug_output = supported_extensions.contains("GL_ARB_debug_output");
/* 6303 */     this.GL_ARB_depth_buffer_float = supported_extensions.contains("GL_ARB_depth_buffer_float");
/* 6304 */     this.GL_ARB_depth_clamp = supported_extensions.contains("GL_ARB_depth_clamp");
/* 6305 */     this.GL_ARB_depth_texture = supported_extensions.contains("GL_ARB_depth_texture");
/* 6306 */     this.GL_ARB_derivative_control = supported_extensions.contains("GL_ARB_derivative_control");
/* 6307 */     this.GL_ARB_direct_state_access = supported_extensions.contains("GL_ARB_direct_state_access");
/* 6308 */     this.GL_ARB_draw_buffers = supported_extensions.contains("GL_ARB_draw_buffers");
/* 6309 */     this.GL_ARB_draw_buffers_blend = supported_extensions.contains("GL_ARB_draw_buffers_blend");
/* 6310 */     this.GL_ARB_draw_elements_base_vertex = supported_extensions.contains("GL_ARB_draw_elements_base_vertex");
/* 6311 */     this.GL_ARB_draw_indirect = supported_extensions.contains("GL_ARB_draw_indirect");
/* 6312 */     this.GL_ARB_draw_instanced = supported_extensions.contains("GL_ARB_draw_instanced");
/* 6313 */     this.GL_ARB_enhanced_layouts = supported_extensions.contains("GL_ARB_enhanced_layouts");
/* 6314 */     this.GL_ARB_explicit_attrib_location = supported_extensions.contains("GL_ARB_explicit_attrib_location");
/* 6315 */     this.GL_ARB_explicit_uniform_location = supported_extensions.contains("GL_ARB_explicit_uniform_location");
/* 6316 */     this.GL_ARB_fragment_coord_conventions = supported_extensions.contains("GL_ARB_fragment_coord_conventions");
/* 6317 */     this.GL_ARB_fragment_layer_viewport = supported_extensions.contains("GL_ARB_fragment_layer_viewport");
/* 6318 */     this.GL_ARB_fragment_program = (supported_extensions.contains("GL_ARB_fragment_program") && supported_extensions.contains("GL_ARB_program"));
/*      */     
/* 6320 */     this.GL_ARB_fragment_program_shadow = supported_extensions.contains("GL_ARB_fragment_program_shadow");
/* 6321 */     this.GL_ARB_fragment_shader = supported_extensions.contains("GL_ARB_fragment_shader");
/* 6322 */     this.GL_ARB_framebuffer_no_attachments = supported_extensions.contains("GL_ARB_framebuffer_no_attachments");
/* 6323 */     this.GL_ARB_framebuffer_object = supported_extensions.contains("GL_ARB_framebuffer_object");
/* 6324 */     this.GL_ARB_framebuffer_sRGB = supported_extensions.contains("GL_ARB_framebuffer_sRGB");
/* 6325 */     this.GL_ARB_geometry_shader4 = supported_extensions.contains("GL_ARB_geometry_shader4");
/* 6326 */     this.GL_ARB_get_program_binary = supported_extensions.contains("GL_ARB_get_program_binary");
/* 6327 */     this.GL_ARB_get_texture_sub_image = supported_extensions.contains("GL_ARB_get_texture_sub_image");
/* 6328 */     this.GL_ARB_gpu_shader5 = supported_extensions.contains("GL_ARB_gpu_shader5");
/* 6329 */     this.GL_ARB_gpu_shader_fp64 = supported_extensions.contains("GL_ARB_gpu_shader_fp64");
/* 6330 */     this.GL_ARB_half_float_pixel = supported_extensions.contains("GL_ARB_half_float_pixel");
/* 6331 */     this.GL_ARB_half_float_vertex = supported_extensions.contains("GL_ARB_half_float_vertex");
/* 6332 */     this.GL_ARB_imaging = supported_extensions.contains("GL_ARB_imaging");
/* 6333 */     this.GL_ARB_indirect_parameters = supported_extensions.contains("GL_ARB_indirect_parameters");
/* 6334 */     this.GL_ARB_instanced_arrays = supported_extensions.contains("GL_ARB_instanced_arrays");
/* 6335 */     this.GL_ARB_internalformat_query = supported_extensions.contains("GL_ARB_internalformat_query");
/* 6336 */     this.GL_ARB_internalformat_query2 = supported_extensions.contains("GL_ARB_internalformat_query2");
/* 6337 */     this.GL_ARB_invalidate_subdata = supported_extensions.contains("GL_ARB_invalidate_subdata");
/* 6338 */     this.GL_ARB_map_buffer_alignment = supported_extensions.contains("GL_ARB_map_buffer_alignment");
/* 6339 */     this.GL_ARB_map_buffer_range = supported_extensions.contains("GL_ARB_map_buffer_range");
/* 6340 */     this.GL_ARB_matrix_palette = supported_extensions.contains("GL_ARB_matrix_palette");
/* 6341 */     this.GL_ARB_multi_bind = supported_extensions.contains("GL_ARB_multi_bind");
/* 6342 */     this.GL_ARB_multi_draw_indirect = supported_extensions.contains("GL_ARB_multi_draw_indirect");
/* 6343 */     this.GL_ARB_multisample = supported_extensions.contains("GL_ARB_multisample");
/* 6344 */     this.GL_ARB_multitexture = supported_extensions.contains("GL_ARB_multitexture");
/* 6345 */     this.GL_ARB_occlusion_query = supported_extensions.contains("GL_ARB_occlusion_query");
/* 6346 */     this.GL_ARB_occlusion_query2 = supported_extensions.contains("GL_ARB_occlusion_query2");
/* 6347 */     this.GL_ARB_pipeline_statistics_query = supported_extensions.contains("GL_ARB_pipeline_statistics_query");
/* 6348 */     this.GL_ARB_pixel_buffer_object = (supported_extensions.contains("GL_ARB_pixel_buffer_object") && supported_extensions.contains("GL_ARB_buffer_object"));
/*      */     
/* 6350 */     this.GL_ARB_point_parameters = supported_extensions.contains("GL_ARB_point_parameters");
/* 6351 */     this.GL_ARB_point_sprite = supported_extensions.contains("GL_ARB_point_sprite");
/* 6352 */     this.GL_ARB_program_interface_query = supported_extensions.contains("GL_ARB_program_interface_query");
/* 6353 */     this.GL_ARB_provoking_vertex = supported_extensions.contains("GL_ARB_provoking_vertex");
/* 6354 */     this.GL_ARB_query_buffer_object = supported_extensions.contains("GL_ARB_query_buffer_object");
/* 6355 */     this.GL_ARB_robust_buffer_access_behavior = supported_extensions.contains("GL_ARB_robust_buffer_access_behavior");
/* 6356 */     this.GL_ARB_robustness = supported_extensions.contains("GL_ARB_robustness");
/* 6357 */     this.GL_ARB_robustness_isolation = supported_extensions.contains("GL_ARB_robustness_isolation");
/* 6358 */     this.GL_ARB_sample_shading = supported_extensions.contains("GL_ARB_sample_shading");
/* 6359 */     this.GL_ARB_sampler_objects = supported_extensions.contains("GL_ARB_sampler_objects");
/* 6360 */     this.GL_ARB_seamless_cube_map = supported_extensions.contains("GL_ARB_seamless_cube_map");
/* 6361 */     this.GL_ARB_seamless_cubemap_per_texture = supported_extensions.contains("GL_ARB_seamless_cubemap_per_texture");
/* 6362 */     this.GL_ARB_separate_shader_objects = supported_extensions.contains("GL_ARB_separate_shader_objects");
/* 6363 */     this.GL_ARB_shader_atomic_counters = supported_extensions.contains("GL_ARB_shader_atomic_counters");
/* 6364 */     this.GL_ARB_shader_bit_encoding = supported_extensions.contains("GL_ARB_shader_bit_encoding");
/* 6365 */     this.GL_ARB_shader_draw_parameters = supported_extensions.contains("GL_ARB_shader_draw_parameters");
/* 6366 */     this.GL_ARB_shader_group_vote = supported_extensions.contains("GL_ARB_shader_group_vote");
/* 6367 */     this.GL_ARB_shader_image_load_store = supported_extensions.contains("GL_ARB_shader_image_load_store");
/* 6368 */     this.GL_ARB_shader_image_size = supported_extensions.contains("GL_ARB_shader_image_size");
/* 6369 */     this.GL_ARB_shader_objects = supported_extensions.contains("GL_ARB_shader_objects");
/* 6370 */     this.GL_ARB_shader_precision = supported_extensions.contains("GL_ARB_shader_precision");
/* 6371 */     this.GL_ARB_shader_stencil_export = supported_extensions.contains("GL_ARB_shader_stencil_export");
/* 6372 */     this.GL_ARB_shader_storage_buffer_object = supported_extensions.contains("GL_ARB_shader_storage_buffer_object");
/* 6373 */     this.GL_ARB_shader_subroutine = supported_extensions.contains("GL_ARB_shader_subroutine");
/* 6374 */     this.GL_ARB_shader_texture_image_samples = supported_extensions.contains("GL_ARB_shader_texture_image_samples");
/* 6375 */     this.GL_ARB_shader_texture_lod = supported_extensions.contains("GL_ARB_shader_texture_lod");
/* 6376 */     this.GL_ARB_shading_language_100 = supported_extensions.contains("GL_ARB_shading_language_100");
/* 6377 */     this.GL_ARB_shading_language_420pack = supported_extensions.contains("GL_ARB_shading_language_420pack");
/* 6378 */     this.GL_ARB_shading_language_include = supported_extensions.contains("GL_ARB_shading_language_include");
/* 6379 */     this.GL_ARB_shading_language_packing = supported_extensions.contains("GL_ARB_shading_language_packing");
/* 6380 */     this.GL_ARB_shadow = supported_extensions.contains("GL_ARB_shadow");
/* 6381 */     this.GL_ARB_shadow_ambient = supported_extensions.contains("GL_ARB_shadow_ambient");
/* 6382 */     this.GL_ARB_sparse_buffer = supported_extensions.contains("GL_ARB_sparse_buffer");
/* 6383 */     this.GL_ARB_sparse_texture = supported_extensions.contains("GL_ARB_sparse_texture");
/* 6384 */     this.GL_ARB_stencil_texturing = supported_extensions.contains("GL_ARB_stencil_texturing");
/* 6385 */     this.GL_ARB_sync = supported_extensions.contains("GL_ARB_sync");
/* 6386 */     this.GL_ARB_tessellation_shader = supported_extensions.contains("GL_ARB_tessellation_shader");
/* 6387 */     this.GL_ARB_texture_barrier = supported_extensions.contains("GL_ARB_texture_barrier");
/* 6388 */     this.GL_ARB_texture_border_clamp = supported_extensions.contains("GL_ARB_texture_border_clamp");
/* 6389 */     this.GL_ARB_texture_buffer_object = supported_extensions.contains("GL_ARB_texture_buffer_object");
/* 6390 */     this.GL_ARB_texture_buffer_object_rgb32 = (supported_extensions.contains("GL_ARB_texture_buffer_object_rgb32") || supported_extensions.contains("GL_EXT_texture_buffer_object_rgb32"));
/*      */     
/* 6392 */     this.GL_ARB_texture_buffer_range = supported_extensions.contains("GL_ARB_texture_buffer_range");
/* 6393 */     this.GL_ARB_texture_compression = supported_extensions.contains("GL_ARB_texture_compression");
/* 6394 */     this.GL_ARB_texture_compression_bptc = (supported_extensions.contains("GL_ARB_texture_compression_bptc") || supported_extensions.contains("GL_EXT_texture_compression_bptc"));
/*      */     
/* 6396 */     this.GL_ARB_texture_compression_rgtc = supported_extensions.contains("GL_ARB_texture_compression_rgtc");
/* 6397 */     this.GL_ARB_texture_cube_map = supported_extensions.contains("GL_ARB_texture_cube_map");
/* 6398 */     this.GL_ARB_texture_cube_map_array = supported_extensions.contains("GL_ARB_texture_cube_map_array");
/* 6399 */     this.GL_ARB_texture_env_add = supported_extensions.contains("GL_ARB_texture_env_add");
/* 6400 */     this.GL_ARB_texture_env_combine = supported_extensions.contains("GL_ARB_texture_env_combine");
/* 6401 */     this.GL_ARB_texture_env_crossbar = supported_extensions.contains("GL_ARB_texture_env_crossbar");
/* 6402 */     this.GL_ARB_texture_env_dot3 = supported_extensions.contains("GL_ARB_texture_env_dot3");
/* 6403 */     this.GL_ARB_texture_float = supported_extensions.contains("GL_ARB_texture_float");
/* 6404 */     this.GL_ARB_texture_gather = supported_extensions.contains("GL_ARB_texture_gather");
/* 6405 */     this.GL_ARB_texture_mirror_clamp_to_edge = supported_extensions.contains("GL_ARB_texture_mirror_clamp_to_edge");
/* 6406 */     this.GL_ARB_texture_mirrored_repeat = supported_extensions.contains("GL_ARB_texture_mirrored_repeat");
/* 6407 */     this.GL_ARB_texture_multisample = supported_extensions.contains("GL_ARB_texture_multisample");
/* 6408 */     this.GL_ARB_texture_non_power_of_two = supported_extensions.contains("GL_ARB_texture_non_power_of_two");
/* 6409 */     this.GL_ARB_texture_query_levels = supported_extensions.contains("GL_ARB_texture_query_levels");
/* 6410 */     this.GL_ARB_texture_query_lod = supported_extensions.contains("GL_ARB_texture_query_lod");
/* 6411 */     this.GL_ARB_texture_rectangle = supported_extensions.contains("GL_ARB_texture_rectangle");
/* 6412 */     this.GL_ARB_texture_rg = supported_extensions.contains("GL_ARB_texture_rg");
/* 6413 */     this.GL_ARB_texture_rgb10_a2ui = supported_extensions.contains("GL_ARB_texture_rgb10_a2ui");
/* 6414 */     this.GL_ARB_texture_stencil8 = supported_extensions.contains("GL_ARB_texture_stencil8");
/* 6415 */     this.GL_ARB_texture_storage = (supported_extensions.contains("GL_ARB_texture_storage") || supported_extensions.contains("GL_EXT_texture_storage"));
/*      */     
/* 6417 */     this.GL_ARB_texture_storage_multisample = supported_extensions.contains("GL_ARB_texture_storage_multisample");
/* 6418 */     this.GL_ARB_texture_swizzle = supported_extensions.contains("GL_ARB_texture_swizzle");
/* 6419 */     this.GL_ARB_texture_view = supported_extensions.contains("GL_ARB_texture_view");
/* 6420 */     this.GL_ARB_timer_query = supported_extensions.contains("GL_ARB_timer_query");
/* 6421 */     this.GL_ARB_transform_feedback2 = supported_extensions.contains("GL_ARB_transform_feedback2");
/* 6422 */     this.GL_ARB_transform_feedback3 = supported_extensions.contains("GL_ARB_transform_feedback3");
/* 6423 */     this.GL_ARB_transform_feedback_instanced = supported_extensions.contains("GL_ARB_transform_feedback_instanced");
/* 6424 */     this.GL_ARB_transform_feedback_overflow_query = supported_extensions.contains("GL_ARB_transform_feedback_overflow_query");
/* 6425 */     this.GL_ARB_transpose_matrix = supported_extensions.contains("GL_ARB_transpose_matrix");
/* 6426 */     this.GL_ARB_uniform_buffer_object = supported_extensions.contains("GL_ARB_uniform_buffer_object");
/* 6427 */     this.GL_ARB_vertex_array_bgra = supported_extensions.contains("GL_ARB_vertex_array_bgra");
/* 6428 */     this.GL_ARB_vertex_array_object = supported_extensions.contains("GL_ARB_vertex_array_object");
/* 6429 */     this.GL_ARB_vertex_attrib_64bit = supported_extensions.contains("GL_ARB_vertex_attrib_64bit");
/* 6430 */     this.GL_ARB_vertex_attrib_binding = supported_extensions.contains("GL_ARB_vertex_attrib_binding");
/* 6431 */     this.GL_ARB_vertex_blend = supported_extensions.contains("GL_ARB_vertex_blend");
/* 6432 */     this.GL_ARB_vertex_buffer_object = (supported_extensions.contains("GL_ARB_vertex_buffer_object") && supported_extensions.contains("GL_ARB_buffer_object"));
/*      */     
/* 6434 */     this.GL_ARB_vertex_program = (supported_extensions.contains("GL_ARB_vertex_program") && supported_extensions.contains("GL_ARB_program"));
/*      */     
/* 6436 */     this.GL_ARB_vertex_shader = supported_extensions.contains("GL_ARB_vertex_shader");
/* 6437 */     this.GL_ARB_vertex_type_10f_11f_11f_rev = supported_extensions.contains("GL_ARB_vertex_type_10f_11f_11f_rev");
/* 6438 */     this.GL_ARB_vertex_type_2_10_10_10_rev = supported_extensions.contains("GL_ARB_vertex_type_2_10_10_10_rev");
/* 6439 */     this.GL_ARB_viewport_array = supported_extensions.contains("GL_ARB_viewport_array");
/* 6440 */     this.GL_ARB_window_pos = supported_extensions.contains("GL_ARB_window_pos");
/* 6441 */     this.GL_ATI_draw_buffers = supported_extensions.contains("GL_ATI_draw_buffers");
/* 6442 */     this.GL_ATI_element_array = supported_extensions.contains("GL_ATI_element_array");
/* 6443 */     this.GL_ATI_envmap_bumpmap = supported_extensions.contains("GL_ATI_envmap_bumpmap");
/* 6444 */     this.GL_ATI_fragment_shader = supported_extensions.contains("GL_ATI_fragment_shader");
/* 6445 */     this.GL_ATI_map_object_buffer = supported_extensions.contains("GL_ATI_map_object_buffer");
/* 6446 */     this.GL_ATI_meminfo = supported_extensions.contains("GL_ATI_meminfo");
/* 6447 */     this.GL_ATI_pn_triangles = supported_extensions.contains("GL_ATI_pn_triangles");
/* 6448 */     this.GL_ATI_separate_stencil = supported_extensions.contains("GL_ATI_separate_stencil");
/* 6449 */     this.GL_ATI_shader_texture_lod = supported_extensions.contains("GL_ATI_shader_texture_lod");
/* 6450 */     this.GL_ATI_text_fragment_shader = supported_extensions.contains("GL_ATI_text_fragment_shader");
/* 6451 */     this.GL_ATI_texture_compression_3dc = supported_extensions.contains("GL_ATI_texture_compression_3dc");
/* 6452 */     this.GL_ATI_texture_env_combine3 = supported_extensions.contains("GL_ATI_texture_env_combine3");
/* 6453 */     this.GL_ATI_texture_float = supported_extensions.contains("GL_ATI_texture_float");
/* 6454 */     this.GL_ATI_texture_mirror_once = supported_extensions.contains("GL_ATI_texture_mirror_once");
/* 6455 */     this.GL_ATI_vertex_array_object = supported_extensions.contains("GL_ATI_vertex_array_object");
/* 6456 */     this.GL_ATI_vertex_attrib_array_object = supported_extensions.contains("GL_ATI_vertex_attrib_array_object");
/* 6457 */     this.GL_ATI_vertex_streams = supported_extensions.contains("GL_ATI_vertex_streams");
/* 6458 */     this.GL_EXT_Cg_shader = supported_extensions.contains("GL_EXT_Cg_shader");
/* 6459 */     this.GL_EXT_abgr = supported_extensions.contains("GL_EXT_abgr");
/* 6460 */     this.GL_EXT_bgra = supported_extensions.contains("GL_EXT_bgra");
/* 6461 */     this.GL_EXT_bindable_uniform = supported_extensions.contains("GL_EXT_bindable_uniform");
/* 6462 */     this.GL_EXT_blend_color = supported_extensions.contains("GL_EXT_blend_color");
/* 6463 */     this.GL_EXT_blend_equation_separate = supported_extensions.contains("GL_EXT_blend_equation_separate");
/* 6464 */     this.GL_EXT_blend_func_separate = supported_extensions.contains("GL_EXT_blend_func_separate");
/* 6465 */     this.GL_EXT_blend_minmax = supported_extensions.contains("GL_EXT_blend_minmax");
/* 6466 */     this.GL_EXT_blend_subtract = supported_extensions.contains("GL_EXT_blend_subtract");
/* 6467 */     this.GL_EXT_compiled_vertex_array = supported_extensions.contains("GL_EXT_compiled_vertex_array");
/* 6468 */     this.GL_EXT_depth_bounds_test = supported_extensions.contains("GL_EXT_depth_bounds_test");
/* 6469 */     this.GL_EXT_direct_state_access = supported_extensions.contains("GL_EXT_direct_state_access");
/* 6470 */     this.GL_EXT_draw_buffers2 = supported_extensions.contains("GL_EXT_draw_buffers2");
/* 6471 */     this.GL_EXT_draw_instanced = supported_extensions.contains("GL_EXT_draw_instanced");
/* 6472 */     this.GL_EXT_draw_range_elements = supported_extensions.contains("GL_EXT_draw_range_elements");
/* 6473 */     this.GL_EXT_fog_coord = supported_extensions.contains("GL_EXT_fog_coord");
/* 6474 */     this.GL_EXT_framebuffer_blit = supported_extensions.contains("GL_EXT_framebuffer_blit");
/* 6475 */     this.GL_EXT_framebuffer_multisample = supported_extensions.contains("GL_EXT_framebuffer_multisample");
/* 6476 */     this.GL_EXT_framebuffer_multisample_blit_scaled = supported_extensions.contains("GL_EXT_framebuffer_multisample_blit_scaled");
/* 6477 */     this.GL_EXT_framebuffer_object = supported_extensions.contains("GL_EXT_framebuffer_object");
/* 6478 */     this.GL_EXT_framebuffer_sRGB = supported_extensions.contains("GL_EXT_framebuffer_sRGB");
/* 6479 */     this.GL_EXT_geometry_shader4 = supported_extensions.contains("GL_EXT_geometry_shader4");
/* 6480 */     this.GL_EXT_gpu_program_parameters = supported_extensions.contains("GL_EXT_gpu_program_parameters");
/* 6481 */     this.GL_EXT_gpu_shader4 = supported_extensions.contains("GL_EXT_gpu_shader4");
/* 6482 */     this.GL_EXT_multi_draw_arrays = supported_extensions.contains("GL_EXT_multi_draw_arrays");
/* 6483 */     this.GL_EXT_packed_depth_stencil = supported_extensions.contains("GL_EXT_packed_depth_stencil");
/* 6484 */     this.GL_EXT_packed_float = supported_extensions.contains("GL_EXT_packed_float");
/* 6485 */     this.GL_EXT_packed_pixels = supported_extensions.contains("GL_EXT_packed_pixels");
/* 6486 */     this.GL_EXT_paletted_texture = supported_extensions.contains("GL_EXT_paletted_texture");
/* 6487 */     this.GL_EXT_pixel_buffer_object = (supported_extensions.contains("GL_EXT_pixel_buffer_object") && supported_extensions.contains("GL_ARB_buffer_object"));
/*      */     
/* 6489 */     this.GL_EXT_point_parameters = supported_extensions.contains("GL_EXT_point_parameters");
/* 6490 */     this.GL_EXT_provoking_vertex = supported_extensions.contains("GL_EXT_provoking_vertex");
/* 6491 */     this.GL_EXT_rescale_normal = supported_extensions.contains("GL_EXT_rescale_normal");
/* 6492 */     this.GL_EXT_secondary_color = supported_extensions.contains("GL_EXT_secondary_color");
/* 6493 */     this.GL_EXT_separate_shader_objects = supported_extensions.contains("GL_EXT_separate_shader_objects");
/* 6494 */     this.GL_EXT_separate_specular_color = supported_extensions.contains("GL_EXT_separate_specular_color");
/* 6495 */     this.GL_EXT_shader_image_load_store = supported_extensions.contains("GL_EXT_shader_image_load_store");
/* 6496 */     this.GL_EXT_shadow_funcs = supported_extensions.contains("GL_EXT_shadow_funcs");
/* 6497 */     this.GL_EXT_shared_texture_palette = supported_extensions.contains("GL_EXT_shared_texture_palette");
/* 6498 */     this.GL_EXT_stencil_clear_tag = supported_extensions.contains("GL_EXT_stencil_clear_tag");
/* 6499 */     this.GL_EXT_stencil_two_side = supported_extensions.contains("GL_EXT_stencil_two_side");
/* 6500 */     this.GL_EXT_stencil_wrap = supported_extensions.contains("GL_EXT_stencil_wrap");
/* 6501 */     this.GL_EXT_texture_3d = supported_extensions.contains("GL_EXT_texture_3d");
/* 6502 */     this.GL_EXT_texture_array = supported_extensions.contains("GL_EXT_texture_array");
/* 6503 */     this.GL_EXT_texture_buffer_object = supported_extensions.contains("GL_EXT_texture_buffer_object");
/* 6504 */     this.GL_EXT_texture_compression_latc = supported_extensions.contains("GL_EXT_texture_compression_latc");
/* 6505 */     this.GL_EXT_texture_compression_rgtc = supported_extensions.contains("GL_EXT_texture_compression_rgtc");
/* 6506 */     this.GL_EXT_texture_compression_s3tc = supported_extensions.contains("GL_EXT_texture_compression_s3tc");
/* 6507 */     this.GL_EXT_texture_env_combine = supported_extensions.contains("GL_EXT_texture_env_combine");
/* 6508 */     this.GL_EXT_texture_env_dot3 = supported_extensions.contains("GL_EXT_texture_env_dot3");
/* 6509 */     this.GL_EXT_texture_filter_anisotropic = supported_extensions.contains("GL_EXT_texture_filter_anisotropic");
/* 6510 */     this.GL_EXT_texture_integer = supported_extensions.contains("GL_EXT_texture_integer");
/* 6511 */     this.GL_EXT_texture_lod_bias = supported_extensions.contains("GL_EXT_texture_lod_bias");
/* 6512 */     this.GL_EXT_texture_mirror_clamp = supported_extensions.contains("GL_EXT_texture_mirror_clamp");
/* 6513 */     this.GL_EXT_texture_rectangle = supported_extensions.contains("GL_EXT_texture_rectangle");
/* 6514 */     this.GL_EXT_texture_sRGB = supported_extensions.contains("GL_EXT_texture_sRGB");
/* 6515 */     this.GL_EXT_texture_sRGB_decode = supported_extensions.contains("GL_EXT_texture_sRGB_decode");
/* 6516 */     this.GL_EXT_texture_shared_exponent = supported_extensions.contains("GL_EXT_texture_shared_exponent");
/* 6517 */     this.GL_EXT_texture_snorm = supported_extensions.contains("GL_EXT_texture_snorm");
/* 6518 */     this.GL_EXT_texture_swizzle = supported_extensions.contains("GL_EXT_texture_swizzle");
/* 6519 */     this.GL_EXT_timer_query = supported_extensions.contains("GL_EXT_timer_query");
/* 6520 */     this.GL_EXT_transform_feedback = supported_extensions.contains("GL_EXT_transform_feedback");
/* 6521 */     this.GL_EXT_vertex_array_bgra = supported_extensions.contains("GL_EXT_vertex_array_bgra");
/* 6522 */     this.GL_EXT_vertex_attrib_64bit = supported_extensions.contains("GL_EXT_vertex_attrib_64bit");
/* 6523 */     this.GL_EXT_vertex_shader = supported_extensions.contains("GL_EXT_vertex_shader");
/* 6524 */     this.GL_EXT_vertex_weighting = supported_extensions.contains("GL_EXT_vertex_weighting");
/* 6525 */     this.OpenGL11 = supported_extensions.contains("OpenGL11");
/* 6526 */     this.OpenGL12 = supported_extensions.contains("OpenGL12");
/* 6527 */     this.OpenGL13 = supported_extensions.contains("OpenGL13");
/* 6528 */     this.OpenGL14 = supported_extensions.contains("OpenGL14");
/* 6529 */     this.OpenGL15 = supported_extensions.contains("OpenGL15");
/* 6530 */     this.OpenGL20 = supported_extensions.contains("OpenGL20");
/* 6531 */     this.OpenGL21 = supported_extensions.contains("OpenGL21");
/* 6532 */     this.OpenGL30 = supported_extensions.contains("OpenGL30");
/* 6533 */     this.OpenGL31 = supported_extensions.contains("OpenGL31");
/* 6534 */     this.OpenGL32 = supported_extensions.contains("OpenGL32");
/* 6535 */     this.OpenGL33 = supported_extensions.contains("OpenGL33");
/* 6536 */     this.OpenGL40 = supported_extensions.contains("OpenGL40");
/* 6537 */     this.OpenGL41 = supported_extensions.contains("OpenGL41");
/* 6538 */     this.OpenGL42 = supported_extensions.contains("OpenGL42");
/* 6539 */     this.OpenGL43 = supported_extensions.contains("OpenGL43");
/* 6540 */     this.OpenGL44 = supported_extensions.contains("OpenGL44");
/* 6541 */     this.OpenGL45 = supported_extensions.contains("OpenGL45");
/* 6542 */     this.GL_GREMEDY_frame_terminator = supported_extensions.contains("GL_GREMEDY_frame_terminator");
/* 6543 */     this.GL_GREMEDY_string_marker = supported_extensions.contains("GL_GREMEDY_string_marker");
/* 6544 */     this.GL_HP_occlusion_test = supported_extensions.contains("GL_HP_occlusion_test");
/* 6545 */     this.GL_IBM_rasterpos_clip = supported_extensions.contains("GL_IBM_rasterpos_clip");
/* 6546 */     this.GL_INTEL_map_texture = supported_extensions.contains("GL_INTEL_map_texture");
/* 6547 */     this.GL_KHR_context_flush_control = supported_extensions.contains("GL_KHR_context_flush_control");
/* 6548 */     this.GL_KHR_debug = supported_extensions.contains("GL_KHR_debug");
/* 6549 */     this.GL_KHR_robust_buffer_access_behavior = supported_extensions.contains("GL_KHR_robust_buffer_access_behavior");
/* 6550 */     this.GL_KHR_robustness = supported_extensions.contains("GL_KHR_robustness");
/* 6551 */     this.GL_KHR_texture_compression_astc_ldr = supported_extensions.contains("GL_KHR_texture_compression_astc_ldr");
/* 6552 */     this.GL_NVX_gpu_memory_info = supported_extensions.contains("GL_NVX_gpu_memory_info");
/* 6553 */     this.GL_NV_bindless_multi_draw_indirect = supported_extensions.contains("GL_NV_bindless_multi_draw_indirect");
/* 6554 */     this.GL_NV_bindless_texture = supported_extensions.contains("GL_NV_bindless_texture");
/* 6555 */     this.GL_NV_blend_equation_advanced = supported_extensions.contains("GL_NV_blend_equation_advanced");
/* 6556 */     this.GL_NV_blend_square = supported_extensions.contains("GL_NV_blend_square");
/* 6557 */     this.GL_NV_compute_program5 = supported_extensions.contains("GL_NV_compute_program5");
/* 6558 */     this.GL_NV_conditional_render = supported_extensions.contains("GL_NV_conditional_render");
/* 6559 */     this.GL_NV_copy_depth_to_color = supported_extensions.contains("GL_NV_copy_depth_to_color");
/* 6560 */     this.GL_NV_copy_image = supported_extensions.contains("GL_NV_copy_image");
/* 6561 */     this.GL_NV_deep_texture3D = supported_extensions.contains("GL_NV_deep_texture3D");
/* 6562 */     this.GL_NV_depth_buffer_float = supported_extensions.contains("GL_NV_depth_buffer_float");
/* 6563 */     this.GL_NV_depth_clamp = supported_extensions.contains("GL_NV_depth_clamp");
/* 6564 */     this.GL_NV_draw_texture = supported_extensions.contains("GL_NV_draw_texture");
/* 6565 */     this.GL_NV_evaluators = supported_extensions.contains("GL_NV_evaluators");
/* 6566 */     this.GL_NV_explicit_multisample = supported_extensions.contains("GL_NV_explicit_multisample");
/* 6567 */     this.GL_NV_fence = supported_extensions.contains("GL_NV_fence");
/* 6568 */     this.GL_NV_float_buffer = supported_extensions.contains("GL_NV_float_buffer");
/* 6569 */     this.GL_NV_fog_distance = supported_extensions.contains("GL_NV_fog_distance");
/* 6570 */     this.GL_NV_fragment_program = (supported_extensions.contains("GL_NV_fragment_program") && supported_extensions.contains("GL_NV_program"));
/*      */     
/* 6572 */     this.GL_NV_fragment_program2 = supported_extensions.contains("GL_NV_fragment_program2");
/* 6573 */     this.GL_NV_fragment_program4 = supported_extensions.contains("GL_NV_fragment_program4");
/* 6574 */     this.GL_NV_fragment_program_option = supported_extensions.contains("GL_NV_fragment_program_option");
/* 6575 */     this.GL_NV_framebuffer_multisample_coverage = supported_extensions.contains("GL_NV_framebuffer_multisample_coverage");
/* 6576 */     this.GL_NV_geometry_program4 = supported_extensions.contains("GL_NV_geometry_program4");
/* 6577 */     this.GL_NV_geometry_shader4 = supported_extensions.contains("GL_NV_geometry_shader4");
/* 6578 */     this.GL_NV_gpu_program4 = supported_extensions.contains("GL_NV_gpu_program4");
/* 6579 */     this.GL_NV_gpu_program5 = supported_extensions.contains("GL_NV_gpu_program5");
/* 6580 */     this.GL_NV_gpu_program5_mem_extended = supported_extensions.contains("GL_NV_gpu_program5_mem_extended");
/* 6581 */     this.GL_NV_gpu_shader5 = supported_extensions.contains("GL_NV_gpu_shader5");
/* 6582 */     this.GL_NV_half_float = supported_extensions.contains("GL_NV_half_float");
/* 6583 */     this.GL_NV_light_max_exponent = supported_extensions.contains("GL_NV_light_max_exponent");
/* 6584 */     this.GL_NV_multisample_coverage = supported_extensions.contains("GL_NV_multisample_coverage");
/* 6585 */     this.GL_NV_multisample_filter_hint = supported_extensions.contains("GL_NV_multisample_filter_hint");
/* 6586 */     this.GL_NV_occlusion_query = supported_extensions.contains("GL_NV_occlusion_query");
/* 6587 */     this.GL_NV_packed_depth_stencil = supported_extensions.contains("GL_NV_packed_depth_stencil");
/* 6588 */     this.GL_NV_parameter_buffer_object = supported_extensions.contains("GL_NV_parameter_buffer_object");
/* 6589 */     this.GL_NV_parameter_buffer_object2 = supported_extensions.contains("GL_NV_parameter_buffer_object2");
/* 6590 */     this.GL_NV_path_rendering = supported_extensions.contains("GL_NV_path_rendering");
/* 6591 */     this.GL_NV_pixel_data_range = supported_extensions.contains("GL_NV_pixel_data_range");
/* 6592 */     this.GL_NV_point_sprite = supported_extensions.contains("GL_NV_point_sprite");
/* 6593 */     this.GL_NV_present_video = supported_extensions.contains("GL_NV_present_video");
/* 6594 */     this.GL_NV_primitive_restart = supported_extensions.contains("GL_NV_primitive_restart");
/* 6595 */     this.GL_NV_register_combiners = supported_extensions.contains("GL_NV_register_combiners");
/* 6596 */     this.GL_NV_register_combiners2 = supported_extensions.contains("GL_NV_register_combiners2");
/* 6597 */     this.GL_NV_shader_atomic_counters = supported_extensions.contains("GL_NV_shader_atomic_counters");
/* 6598 */     this.GL_NV_shader_atomic_float = supported_extensions.contains("GL_NV_shader_atomic_float");
/* 6599 */     this.GL_NV_shader_buffer_load = supported_extensions.contains("GL_NV_shader_buffer_load");
/* 6600 */     this.GL_NV_shader_buffer_store = supported_extensions.contains("GL_NV_shader_buffer_store");
/* 6601 */     this.GL_NV_shader_storage_buffer_object = supported_extensions.contains("GL_NV_shader_storage_buffer_object");
/* 6602 */     this.GL_NV_tessellation_program5 = supported_extensions.contains("GL_NV_tessellation_program5");
/* 6603 */     this.GL_NV_texgen_reflection = supported_extensions.contains("GL_NV_texgen_reflection");
/* 6604 */     this.GL_NV_texture_barrier = supported_extensions.contains("GL_NV_texture_barrier");
/* 6605 */     this.GL_NV_texture_compression_vtc = supported_extensions.contains("GL_NV_texture_compression_vtc");
/* 6606 */     this.GL_NV_texture_env_combine4 = supported_extensions.contains("GL_NV_texture_env_combine4");
/* 6607 */     this.GL_NV_texture_expand_normal = supported_extensions.contains("GL_NV_texture_expand_normal");
/* 6608 */     this.GL_NV_texture_multisample = supported_extensions.contains("GL_NV_texture_multisample");
/* 6609 */     this.GL_NV_texture_rectangle = supported_extensions.contains("GL_NV_texture_rectangle");
/* 6610 */     this.GL_NV_texture_shader = supported_extensions.contains("GL_NV_texture_shader");
/* 6611 */     this.GL_NV_texture_shader2 = supported_extensions.contains("GL_NV_texture_shader2");
/* 6612 */     this.GL_NV_texture_shader3 = supported_extensions.contains("GL_NV_texture_shader3");
/* 6613 */     this.GL_NV_transform_feedback = supported_extensions.contains("GL_NV_transform_feedback");
/* 6614 */     this.GL_NV_transform_feedback2 = supported_extensions.contains("GL_NV_transform_feedback2");
/* 6615 */     this.GL_NV_vertex_array_range = supported_extensions.contains("GL_NV_vertex_array_range");
/* 6616 */     this.GL_NV_vertex_array_range2 = supported_extensions.contains("GL_NV_vertex_array_range2");
/* 6617 */     this.GL_NV_vertex_attrib_integer_64bit = supported_extensions.contains("GL_NV_vertex_attrib_integer_64bit");
/* 6618 */     this.GL_NV_vertex_buffer_unified_memory = supported_extensions.contains("GL_NV_vertex_buffer_unified_memory");
/* 6619 */     this.GL_NV_vertex_program = (supported_extensions.contains("GL_NV_vertex_program") && supported_extensions.contains("GL_NV_program"));
/*      */     
/* 6621 */     this.GL_NV_vertex_program1_1 = supported_extensions.contains("GL_NV_vertex_program1_1");
/* 6622 */     this.GL_NV_vertex_program2 = supported_extensions.contains("GL_NV_vertex_program2");
/* 6623 */     this.GL_NV_vertex_program2_option = supported_extensions.contains("GL_NV_vertex_program2_option");
/* 6624 */     this.GL_NV_vertex_program3 = supported_extensions.contains("GL_NV_vertex_program3");
/* 6625 */     this.GL_NV_vertex_program4 = supported_extensions.contains("GL_NV_vertex_program4");
/* 6626 */     this.GL_NV_video_capture = supported_extensions.contains("GL_NV_video_capture");
/* 6627 */     this.GL_SGIS_generate_mipmap = supported_extensions.contains("GL_SGIS_generate_mipmap");
/* 6628 */     this.GL_SGIS_texture_lod = supported_extensions.contains("GL_SGIS_texture_lod");
/* 6629 */     this.GL_SUN_slice_accum = supported_extensions.contains("GL_SUN_slice_accum");
/* 6630 */     this.tracker.init();
/*      */   }
/*      */ }


/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\ContextCapabilities.class
