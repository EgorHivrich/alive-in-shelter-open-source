...
/*  213 */     BufferChecks.checkArray((Object[])strings);
...
/*  679 */     nglGetActiveUniform(program, index, 1, 0L, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
...
/*  962 */     ContextCapabilities caps = GLContext.getCapabilities();
/*  963 */     long function_pointer = caps.glGetVertexAttribPointerv;
/*  964 */     BufferChecks.checkFunctionAddress(function_pointer);
/*  965 */     BufferChecks.checkBuffer(pointer, PointerBuffer.getPointerSize());
/*  966 */     nglGetVertexAttribPointerv2(index, pname, MemoryUtil.getAddress(pointer), function_pointer);
/*      */   }
...
/*  972 */     long function_pointer = caps.glBindAttribLocation;
/*  973 */     BufferChecks.checkFunctionAddress(function_pointer);
/*  974 */     BufferChecks.checkDirect(name);
/*  975 */     BufferChecks.checkNullTerminated(name);
/*  976 */     nglBindAttribLocation(program, index, MemoryUtil.getAddress(name), function_pointer);
/*      */   }
/*      */   
...
/*  983 */     long function_pointer = caps.glBindAttribLocation;
/*  984 */     BufferChecks.checkFunctionAddress(function_pointer);
/*  985 */     nglBindAttribLocation(program, index, APIUtil.getBufferNT(caps, name), function_pointer);
/*      */   }
/*      */   
...
/*  990 */     long function_pointer = caps.glGetActiveAttrib;
/*  991 */     BufferChecks.checkFunctionAddress(function_pointer);
/*  992 */     if (length != null)
/*  993 */       BufferChecks.checkBuffer(length, 1); 
/*  994 */     BufferChecks.checkBuffer(size, 1);
/*  995 */     BufferChecks.checkBuffer(type, 1);
/*  996 */     BufferChecks.checkDirect(name);
/*  997 */     nglGetActiveAttrib(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type), MemoryUtil.getAddress(name), function_pointer);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* 1008 */     long function_pointer = caps.glGetActiveAttrib;
/* 1009 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1010 */     BufferChecks.checkBuffer(sizeType, 2);
/* 1011 */     IntBuffer name_length = APIUtil.getLengths(caps);
/* 1012 */     ByteBuffer name = APIUtil.getBufferByte(caps, maxLength);
/* 1013 */     nglGetActiveAttrib(program, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress(sizeType), MemoryUtil.getAddress(sizeType, sizeType.position() + 1), MemoryUtil.getAddress(name), function_pointer);
/* 1014 */     name.limit(name_length.get(0));
/* 1015 */     return APIUtil.getString(caps, name);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1025 */     long function_pointer = caps.glGetActiveAttrib;
/* 1026 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1027 */     IntBuffer name_length = APIUtil.getLengths(caps);
/* 1028 */     ByteBuffer name = APIUtil.getBufferByte(caps, maxLength);
/* 1029 */     nglGetActiveAttrib(program, index, maxLength, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress0(APIUtil.getBufferInt(caps)), MemoryUtil.getAddress(APIUtil.getBufferInt(caps), 1), MemoryUtil.getAddress(name), function_pointer);
/* 1030 */     name.limit(name_length.get(0));
/* 1031 */     return APIUtil.getString(caps, name);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1041 */     long function_pointer = caps.glGetActiveAttrib;
/* 1042 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1043 */     IntBuffer size = APIUtil.getBufferInt(caps);
/* 1044 */     nglGetActiveAttrib(program, index, 0, 0L, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
/* 1045 */     return size.get(0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1055 */     long function_pointer = caps.glGetActiveAttrib;
/* 1056 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1057 */     IntBuffer type = APIUtil.getBufferInt(caps);
/* 1058 */     nglGetActiveAttrib(program, index, 0, 0L, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
/* 1059 */     return type.get(0);
/*      */   }
/*      */   
/*      */   public static int glGetAttribLocation(int program, ByteBuffer name) {
/* 1063 */     ContextCapabilities caps = GLContext.getCapabilities();
/* 1064 */     long function_pointer = caps.glGetAttribLocation;
/* 1065 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1066 */     BufferChecks.checkDirect(name);
/* 1067 */     BufferChecks.checkNullTerminated(name);
/* 1068 */     int __result = nglGetAttribLocation(program, MemoryUtil.getAddress(name), function_pointer);
...
/* 1075 */     ContextCapabilities caps = GLContext.getCapabilities();
/* 1076 */     long function_pointer = caps.glGetAttribLocation;
/* 1077 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1078 */     int __result = nglGetAttribLocation(program, APIUtil.getBufferNT(caps, name), function_pointer);
...
/* 1086 */     BufferChecks.checkDirect(buffers);
/* 1087 */     nglDrawBuffers(buffers.remaining(), MemoryUtil.getAddress(buffers), function_pointer);
/*      */   }
/*      */   
...
/* 1094 */     long function_pointer = caps.glDrawBuffers;
/* 1095 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1096 */     nglDrawBuffers(1, APIUtil.getInt(caps, buffer), function_pointer);
/*      */   }
/*      */   
/*      */   public static void glStencilOpSeparate(int face, int sfail, int dpfail, int dppass) {
/* 1100 */     ContextCapabilities caps = GLContext.getCapabilities();
/* 1101 */     long function_pointer = caps.glStencilOpSeparate;
/* 1102 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1103 */     nglStencilOpSeparate(face, sfail, dpfail, dppass, function_pointer);
/*      */   }
...
/* 1108 */     ContextCapabilities caps = GLContext.getCapabilities();
/* 1109 */     long function_pointer = caps.glStencilFuncSeparate;
/* 1110 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1111 */     nglStencilFuncSeparate(face, func, ref, mask, function_pointer);
/*      */   }
...
/* 1116 */     ContextCapabilities caps = GLContext.getCapabilities();
/* 1117 */     long function_pointer = caps.glStencilMaskSeparate;
/* 1118 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1119 */     nglStencilMaskSeparate(face, mask, function_pointer);
/*      */   }
...
/* 1125 */     long function_pointer = caps.glBlendEquationSeparate;
/* 1126 */     BufferChecks.checkFunctionAddress(function_pointer);
/* 1127 */     nglBlendEquationSeparate(modeRGB, modeAlpha, function_pointer);
/*      */   }
/*      */   
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\GL20.class
