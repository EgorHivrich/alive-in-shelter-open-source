...
/* 211 */     if (dz != 0.0F) {
/*     */       
/* 213 */       if (dy == 0.0F) dy = dx;
/*     */       
/* 215 */       int wheel_amount = (int)(dy * 120.0F);
/* 216 */       this.accum_dz += wheel_amount;
/* 217 */       putMouseEvent((byte)-1, (byte)0, wheel_amount, nanos);
/*     */     }
/* 219 */     else if (this.grabbed) {
/* 220 */       if (dx != 0.0F || dy != 0.0F) {
/* 221 */         putMouseEventWithCoords((byte)-1, (byte)0, (int)dx, (int)-dy, 0, nanos);
/* 222 */         addDelta(dx, dy);
/*     */       } 
/*     */     } else {
/* 225 */       setCursorPos(x, y, nanos);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\MacOSXNativeMouse.class
