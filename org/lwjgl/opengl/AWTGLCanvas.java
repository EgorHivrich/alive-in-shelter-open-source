...
/* 168 */     this(device, pixel_format, (Drawable)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 179 */     this(device, pixel_format, drawable, (ContextAttribs)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 323 */             this.context = new ContextGL(this.peer_info, this.attribs, (this.drawable != null) ? (ContextGL)((DrawableLWJGL)this.drawable).getContext() : null);
/* 324 */             this.first_run = true;
/*     */           } 
/*     */           
/* 327 */           if (this.reentry_count == 0)
/* 328 */             this.context.makeCurrent(); 
/* 329 */           this.reentry_count++;
/*     */           try {
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\opengl\AWTGLCanvas.class
