...
/* 206 */       posShift = 0;
/* 207 */     } else if (buffer instanceof ShortBuffer) {
/* 208 */       checkBuffer((ShortBuffer)buffer, size);
/* 209 */       posShift = 1;
/* 210 */     } else if (buffer instanceof IntBuffer) {
/* 211 */       checkBuffer((IntBuffer)buffer, size);
/* 212 */       posShift = 2;
/* 213 */     } else if (buffer instanceof LongBuffer) {
/* 214 */       checkBuffer((LongBuffer)buffer, size);
/* 215 */       posShift = 4;
/* 216 */     } else if (buffer instanceof FloatBuffer) {
/* 217 */       checkBuffer((FloatBuffer)buffer, size);
/* 218 */       posShift = 2;
/* 219 */     } else if (buffer instanceof DoubleBuffer) {
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\org\lwjgl\BufferChecks.class
