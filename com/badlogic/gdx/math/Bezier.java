...
/*  94 */     float t2 = t * t;
/*     */     
/*  96 */     return out.set(p0).scl(dt2 * dt).add(tmp.set(p1).scl(3.0F * dt2 * t)).add(tmp.set(p2).scl(3.0F * dt * t2)).add(tmp.set(p3).scl(t2 * t));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\com\badlogic\gdx\math\Bezier.class
