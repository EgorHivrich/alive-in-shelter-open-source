...
/*  50 */     super(map);
/*  51 */     this.keys = new Array<K>(this.capacity);
/*     */   }
/*     */   
...
/* 188 */       super(map);
/* 189 */       this.keys = map.keys;
/*     */     }
/*     */     
/*     */     public void reset() {
/* 193 */       this.nextIndex = 0;
/* 194 */       this.hasNext = (this.map.size > 0);
/*     */     }
/*     */     
/*     */     public K next() {
/* 198 */       if (!this.hasNext) throw new NoSuchElementException(); 
/* 199 */       if (!this.valid) throw new GdxRuntimeException("#iterator() cannot be used nested."); 
/* 200 */       K key = this.keys.get(this.nextIndex);
/* 201 */       this.nextIndex++;
/* 202 */       this.hasNext = (this.nextIndex < this.map.size);
/* 203 */       return key;
/*     */     }
/*     */     
/*     */     public void remove() {
/* 207 */       if (this.currentIndex < 0) throw new IllegalStateException("next must be called before remove."); 
/* 208 */       this.map.remove(this.keys.get(this.nextIndex - 1));
/*     */     }
/*     */   }
/*     */   
...
/* 216 */       super(map);
/* 217 */       this.keys = map.keys;
/*     */     }
/*     */     
/*     */     public void reset() {
/* 221 */       this.nextIndex = 0;
/* 222 */       this.hasNext = (this.map.size > 0);
/*     */     }
/*     */     
/*     */     public V next() {
/* 226 */       if (!this.hasNext) throw new NoSuchElementException(); 
/* 227 */       if (!this.valid) throw new GdxRuntimeException("#iterator() cannot be used nested."); 
/* 228 */       V value = this.map.get(this.keys.get(this.nextIndex));
/* 229 */       this.nextIndex++;
/* 230 */       this.hasNext = (this.nextIndex < this.map.size);
/* 231 */       return value;
/*     */     }
/*     */     
/*     */     public void remove() {
/* 235 */       if (this.currentIndex < 0) throw new IllegalStateException("next must be called before remove."); 
/* 236 */       this.map.remove(this.keys.get(this.nextIndex - 1));
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\com\badlogic\gd\\utils\OrderedMap.class
