...
/*  346 */       invalidate();
/*      */     } 
/*  348 */     if (this.rowDefaults != null) cellPool.free(this.rowDefaults); 
/*  349 */     this.rowDefaults = obtainCell();
/*  350 */     this.rowDefaults.clear();
/*  351 */     return this.rowDefaults;
/*      */   }
/*      */   
/*      */   private void endRow() {
/*  355 */     Array<Cell> cells = this.cells;
/*  356 */     int rowColumns = 0;
/*  357 */     for (int i = cells.size - 1; i >= 0; i--) {
/*  358 */       Cell cell = (Cell)cells.get(i);
/*  359 */       if (cell.endRow)
/*  360 */         break;  rowColumns += cell.colspan.intValue();
/*      */     } 
/*  362 */     this.columns = Math.max(this.columns, rowColumns);
/*  363 */     this.rows++;
/*  364 */     ((Cell)cells.peek()).endRow = true;
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   public Cell columnDefaults(int column) {
/*  370 */     Cell cell = (this.columnDefaults.size > column) ? (Cell)this.columnDefaults.get(column) : null;
/*  371 */     if (cell == null) {
/*  372 */       cell = obtainCell();
/*  373 */       cell.clear();
/*  374 */       if (column >= this.columnDefaults.size) {
/*  375 */         for (int i = this.columnDefaults.size; i < column; i++)
/*  376 */           this.columnDefaults.add(null); 
/*  377 */         this.columnDefaults.add(cell);
/*      */       } else {
/*  379 */         this.columnDefaults.set(column, cell);
/*      */       } 
/*  381 */     }  return cell;
/*      */   }
/*      */ 
...
/*  386 */     Array<Cell> cells = this.cells;
/*  387 */     for (int i = 0, n = cells.size; i < n; i++) {
/*  388 */       Cell<T> c = (Cell)cells.get(i);
/*  389 */       if (c.actor == actor) return c; 
/*      */     } 
/*  391 */     return null;
/*      */   }
/*      */ 
...
/*  396 */     return this.cells;
/*      */   }
/*      */   
/*      */   public float getPrefWidth() {
/*  400 */     if (this.sizeInvalid) computeSize(); 
/*  401 */     float width = this.tablePrefWidth;
/*  402 */     if (this.background != null) return Math.max(width, this.background.getMinWidth()); 
/*  403 */     return width;
/*      */   }
/*      */   
/*      */   public float getPrefHeight() {
/*  407 */     if (this.sizeInvalid) computeSize(); 
/*  408 */     float height = this.tablePrefHeight;
/*  409 */     if (this.background != null) return Math.max(height, this.background.getMinHeight()); 
/*  410 */     return height;
/*      */   }
/*      */   
/*      */   public float getMinWidth() {
/*  414 */     if (this.sizeInvalid) computeSize(); 
/*  415 */     return this.tableMinWidth;
/*      */   }
/*      */   
/*      */   public float getMinHeight() {
/*  419 */     if (this.sizeInvalid) computeSize(); 
/*  420 */     return this.tableMinHeight;
/*      */   }
/*      */ 
/*      */   
/*      */   public Cell defaults() {
/*  425 */     return this.cellDefaults;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table pad(Value pad) {
/*  430 */     if (pad == null) throw new IllegalArgumentException("pad cannot be null."); 
/*  431 */     this.padTop = pad;
/*  432 */     this.padLeft = pad;
/*  433 */     this.padBottom = pad;
/*  434 */     this.padRight = pad;
/*  435 */     this.sizeInvalid = true;
/*  436 */     return this;
/*      */   }
/*      */   
/*      */   public Table pad(Value top, Value left, Value bottom, Value right) {
/*  440 */     if (top == null) throw new IllegalArgumentException("top cannot be null."); 
/*  441 */     if (left == null) throw new IllegalArgumentException("left cannot be null."); 
/*  442 */     if (bottom == null) throw new IllegalArgumentException("bottom cannot be null."); 
/*  443 */     if (right == null) throw new IllegalArgumentException("right cannot be null."); 
/*  444 */     this.padTop = top;
/*  445 */     this.padLeft = left;
/*  446 */     this.padBottom = bottom;
/*  447 */     this.padRight = right;
/*  448 */     this.sizeInvalid = true;
/*  449 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padTop(Value padTop) {
/*  454 */     if (padTop == null) throw new IllegalArgumentException("padTop cannot be null."); 
/*  455 */     this.padTop = padTop;
/*  456 */     this.sizeInvalid = true;
/*  457 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padLeft(Value padLeft) {
/*  462 */     if (padLeft == null) throw new IllegalArgumentException("padLeft cannot be null."); 
/*  463 */     this.padLeft = padLeft;
/*  464 */     this.sizeInvalid = true;
/*  465 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padBottom(Value padBottom) {
/*  470 */     if (padBottom == null) throw new IllegalArgumentException("padBottom cannot be null."); 
/*  471 */     this.padBottom = padBottom;
/*  472 */     this.sizeInvalid = true;
/*  473 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padRight(Value padRight) {
/*  478 */     if (padRight == null) throw new IllegalArgumentException("padRight cannot be null."); 
/*  479 */     this.padRight = padRight;
...
/*  486 */     pad(new Value.Fixed(pad));
/*  487 */     return this;
/*      */   }
/*      */   
/*      */   public Table pad(float top, float left, float bottom, float right) {
/*  491 */     this.padTop = new Value.Fixed(top);
/*  492 */     this.padLeft = new Value.Fixed(left);
/*  493 */     this.padBottom = new Value.Fixed(bottom);
/*  494 */     this.padRight = new Value.Fixed(right);
/*  495 */     this.sizeInvalid = true;
/*  496 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padTop(float padTop) {
/*  501 */     this.padTop = new Value.Fixed(padTop);
/*  502 */     this.sizeInvalid = true;
/*  503 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padLeft(float padLeft) {
/*  508 */     this.padLeft = new Value.Fixed(padLeft);
/*  509 */     this.sizeInvalid = true;
/*  510 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padBottom(float padBottom) {
/*  515 */     this.padBottom = new Value.Fixed(padBottom);
/*  516 */     this.sizeInvalid = true;
/*  517 */     return this;
/*      */   }
/*      */ 
/*      */   
/*      */   public Table padRight(float padRight) {
/*  522 */     this.padRight = new Value.Fixed(padRight);
/*  523 */     this.sizeInvalid = true;
/*  524 */     return this;
/*      */   }
/*      */ 
/*      */ 
...
/*      */   public Table right() {
/*  563 */     this.align |= 0x10;
/*  564 */     this.align &= 0xFFFFFFF7;
/*  565 */     return this;
/*      */   }
/*      */   
/*      */   public void setDebug(boolean enabled) {
/*  569 */     debug(enabled ? Debug.all : Debug.none);
/*      */   }
/*      */   
/*      */   public Table debug() {
/*  573 */     super.debug();
...
/*  584 */     super.setDebug(true);
/*  585 */     if (this.debug != Debug.table) {
/*  586 */       this.debug = Debug.table;
/*  587 */       invalidate();
/*      */     } 
/*  589 */     return this;
/*      */   }
...
/*  594 */     super.setDebug(true);
/*  595 */     if (this.debug != Debug.cell) {
/*  596 */       this.debug = Debug.cell;
/*  597 */       invalidate();
/*      */     } 
/*  599 */     return this;
/*      */   }
...
/*  604 */     super.setDebug(true);
/*  605 */     if (this.debug != Debug.actor) {
/*  606 */       this.debug = Debug.actor;
/*  607 */       invalidate();
/*      */     } 
/*  609 */     return this;
/*      */   }
...
/*  614 */     super.setDebug((debug != Debug.none));
/*  615 */     if (this.debug != debug) {
/*  616 */       this.debug = debug;
/*  617 */       if (debug == Debug.none) {
/*  618 */         clearDebugRects();
/*      */       } else {
/*  620 */         invalidate();
/*      */       } 
...
/*  626 */     return this.debug;
/*      */   }
/*      */   
/*      */   public Value getPadTopValue() {
/*  630 */     return this.padTop;
/*      */   }
/*      */   
/*      */   public float getPadTop() {
/*  634 */     return this.padTop.get((Actor)this);
/*      */   }
/*      */   
/*      */   public Value getPadLeftValue() {
/*  638 */     return this.padLeft;
/*      */   }
/*      */   
/*      */   public float getPadLeft() {
/*  642 */     return this.padLeft.get((Actor)this);
/*      */   }
/*      */   
/*      */   public Value getPadBottomValue() {
/*  646 */     return this.padBottom;
/*      */   }
/*      */   
/*      */   public float getPadBottom() {
/*  650 */     return this.padBottom.get((Actor)this);
/*      */   }
/*      */   
/*      */   public Value getPadRightValue() {
/*  654 */     return this.padRight;
/*      */   }
/*      */   
/*      */   public float getPadRight() {
/*  658 */     return this.padRight.get((Actor)this);
/*      */   }
/*      */ 
/*      */   
/*      */   public float getPadX() {
/*  663 */     return this.padLeft.get((Actor)this) + this.padRight.get((Actor)this);
/*      */   }
/*      */ 
/*      */   
/*      */   public float getPadY() {
/*  668 */     return this.padTop.get((Actor)this) + this.padBottom.get((Actor)this);
/*      */   }
/*      */   
/*      */   public int getAlign() {
/*  672 */     return this.align;
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   public int getRow(float y) {
/*  678 */     Array<Cell> cells = this.cells;
/*  679 */     int row = 0;
/*  680 */     y += getPadTop();
/*  681 */     int i = 0, n = cells.size;
/*  682 */     if (n == 0) return -1; 
/*  683 */     if (n == 1) return 0; 
/*  684 */     while (i < n) {
/*  685 */       Cell c = (Cell)cells.get(i++);
/*  686 */       if (c.actorY + c.computedPadTop < y)
/*  687 */         break;  if (c.endRow) row++; 
/*      */     } 
/*  689 */     return row;
/*      */   }
/*      */   
...
/*  698 */     this.round = round;
/*      */   }
/*      */   
/*      */   public int getRows() {
/*  702 */     return this.rows;
/*      */   }
/*      */   
...
/*  711 */     return this.rowHeight[rowIndex];
/*      */   }
/*      */ 
/*      */   
/*      */   public float getColumnWidth(int columnIndex) {
/*  716 */     return this.columnWidth[columnIndex];
/*      */   }
/*      */   
/*      */   private float[] ensureSize(float[] array, int size) {
/*  720 */     if (array == null || array.length < size) return new float[size]; 
/*  721 */     for (int i = 0, n = array.length; i < n; i++)
/*  722 */       array[i] = 0.0F; 
/*  723 */     return array;
/*      */   }
/*      */   
/*      */   public void layout() {
/*  727 */     float width = getWidth();
/*  728 */     float height = getHeight();
/*      */     
/*  730 */     layout(0.0F, 0.0F, width, height);
/*      */     
/*  732 */     Array<Cell> cells = this.cells;
/*  733 */     if (this.round) {
/*  734 */       for (int j = 0, k = cells.size; j < k; j++) {
/*  735 */         Cell c = (Cell)cells.get(j);
/*  736 */         float actorWidth = Math.round(c.actorWidth);
/*  737 */         float actorHeight = Math.round(c.actorHeight);
/*  738 */         float actorX = Math.round(c.actorX);
/*  739 */         float actorY = height - Math.round(c.actorY) - actorHeight;
/*  740 */         c.setActorBounds(actorX, actorY, actorWidth, actorHeight);
/*  741 */         Actor actor = c.actor;
/*  742 */         if (actor != null) actor.setBounds(actorX, actorY, actorWidth, actorHeight); 
/*      */       } 
/*      */     } else {
/*  745 */       for (int j = 0, k = cells.size; j < k; j++) {
/*  746 */         Cell c = (Cell)cells.get(j);
/*  747 */         float actorHeight = c.actorHeight;
/*  748 */         float actorY = height - c.actorY - actorHeight;
/*  749 */         c.setActorY(actorY);
/*  750 */         Actor actor = c.actor;
/*  751 */         if (actor != null) actor.setBounds(c.actorX, actorY, c.actorWidth, actorHeight);
/*      */       
/*      */       } 
/*      */     } 
/*  755 */     SnapshotArray snapshotArray = getChildren();
/*  756 */     for (int i = 0, n = ((Array)snapshotArray).size; i < n; i++) {
/*  757 */       Actor child = (Actor)snapshotArray.get(i);
/*  758 */       if (child instanceof Layout) ((Layout)child).validate(); 
/*      */     } 
/*      */   }
/*      */   
/*      */   private void computeSize() {
/*  763 */     this.sizeInvalid = false;
/*      */     
/*  765 */     Array<Cell> cells = this.cells;
/*  766 */     int cellCount = cells.size;
/*      */ 
/*      */     
/*  769 */     if (cellCount > 0 && !((Cell)cells.peek()).endRow) {
/*  770 */       endRow();
/*  771 */       this.implicitEndRow = true;
/*      */     } else {
/*  773 */       this.implicitEndRow = false;
/*      */     } 
...
/*  832 */     label129: for (j = 0; j < cellCount; j++) {
...
/*  843 */             continue label129;  }  for (ii = column; ii < nn; ii++) {
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\com\badlogic\gdx\scenes\scene2\\ui\Table.class
