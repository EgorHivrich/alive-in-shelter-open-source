...
/*      */           } 
/*      */           
/*  890 */           KeyEvent event = (KeyEvent)this.usedKeyEvents.obtain();
/*  891 */           event.keyCode = 0;
/*  892 */           event.keyChar = keyChar;
/*  893 */           event.type = 2;
/*  894 */           event.timeStamp = timeStamp;
/*  895 */           this.keyEvents.add(event);
/*      */           
/*  897 */           if (keyCode != 0) {
/*  898 */             event = (KeyEvent)this.usedKeyEvents.obtain();
/*  899 */             event.keyCode = keyCode;
/*  900 */             event.keyChar = Character.MIN_VALUE;
/*  901 */             event.type = 0;
/*  902 */             event.timeStamp = timeStamp;
/*  903 */             this.keyEvents.add(event);
/*      */             
/*  905 */             this.pressedKeys++;
/*  906 */             this.keyJustPressed = true;
/*  907 */             this.justPressedKeys[keyCode] = true;
/*  908 */             this.lastKeyCharPressed = keyChar;
/*  909 */             this.keyRepeatTimer = keyRepeatInitialTime;
/*      */           } 
/*      */         } else {
...
/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\com\badlogic\gdx\backends\lwjgl\LwjglInput.class
