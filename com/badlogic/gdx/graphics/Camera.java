...
/* 195 */     x -= viewportX;
/* 196 */     y = Gdx.graphics.getHeight() - y - 1.0F;
/* 197 */     y -= viewportY;
/* 198 */     screenCoords.x = 2.0F * x / viewportWidth - 1.0F;
/* 199 */     screenCoords.y = 2.0F * y / viewportHeight - 1.0F;
/* 200 */     screenCoords.z = 2.0F * screenCoords.z - 1.0F;
/* 201 */     screenCoords.prj(this.invProjectionView);
...
/* 212 */     unproject(screenCoords, 0.0F, 0.0F, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
...
/* 221 */     project(worldCoords, 0.0F, 0.0F, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
...
/* 236 */     worldCoords.prj(this.combined);
/* 237 */     worldCoords.x = viewportWidth * (worldCoords.x + 1.0F) / 2.0F + viewportX;
/* 238 */     worldCoords.y = viewportHeight * (worldCoords.y + 1.0F) / 2.0F + viewportY;
/* 239 */     worldCoords.z = (worldCoords.z + 1.0F) / 2.0F;
...
/* 253 */     unproject(this.ray.origin.set(screenX, screenY, 0.0F), viewportX, viewportY, viewportWidth, viewportHeight);
/* 254 */     unproject(this.ray.direction.set(screenX, screenY, 1.0F), viewportX, viewportY, viewportWidth, viewportHeight);
/* 255 */     this.ray.direction.sub(this.ray.origin).nor();
/* 256 */     return this.ray;
/*     */   }
/*     */ 
/*     */ 
...
/* 264 */     return getPickRay(screenX, screenY, 0.0F, 0.0F, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
/*     */   }
/*     */ }


/* Location:              C:\Users\egorh\Downloads\Alive In Shelter.jar!\com\badlogic\gdx\graphics\Camera.class
